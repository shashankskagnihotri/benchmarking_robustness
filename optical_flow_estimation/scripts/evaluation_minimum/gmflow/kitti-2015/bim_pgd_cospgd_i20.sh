...
#SBATCH --array=0-20%4
#SBATCH --job-name=gmflow_kitti-2015_bim_pgd_cospgd_i20
#SBATCH --output=slurm/gmflow_kitti-2015_bim_pgd_cospgd_i20_%A_%a.out
#SBATCH --error=slurm/gmflow_kitti-2015_bim_pgd_cospgd_i20_err_%A_%a.out
