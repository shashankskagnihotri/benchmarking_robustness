...
#SBATCH --job-name=gmflow_sintel-final_pcfa
#SBATCH --output=slurm/gmflow_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/gmflow_sintel-final_pcfa_err_%A_%a.out
