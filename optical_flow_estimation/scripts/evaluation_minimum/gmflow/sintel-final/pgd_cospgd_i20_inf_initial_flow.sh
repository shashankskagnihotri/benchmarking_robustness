...
#SBATCH --array=0-1%2
#SBATCH --job-name=gmflow_sintel-final_pgd_cospgd_i20_inf_init
#SBATCH --output=slurm/gmflow_sintel-final_pgd_cospgd_i20_inf_init_%A_%a.out
#SBATCH --error=slurm/gmflow_sintel-final_pgd_cospgd_i20_inf_init_err_%A_%a.out
