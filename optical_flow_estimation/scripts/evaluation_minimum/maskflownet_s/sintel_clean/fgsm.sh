...
#SBATCH --array=0-14%4
#SBATCH --job-name=maskflownet_s_sintel-clean_fgsm
#SBATCH --output=slurm/maskflownet_s_sintel-clean_fgsm_%A_%a.out
#SBATCH --error=slurm/maskflownet_s_sintel-clean_fgsm_err_%A_%a.out
