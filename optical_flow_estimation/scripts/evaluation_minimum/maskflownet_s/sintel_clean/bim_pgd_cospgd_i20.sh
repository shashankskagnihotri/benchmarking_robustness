...
#SBATCH --array=0-35%4
#SBATCH --job-name=maskflownet_s_sintel-clean_bim_pgd_cospgd_i20
#SBATCH --output=slurm/maskflownet_s_sintel-clean_bim_pgd_cospgd_i20_%A_%a.out
#SBATCH --error=slurm/maskflownet_s_sintel-clean_bim_pgd_cospgd_i20_err_%A_%a.out
