...
#SBATCH --array=0-1%2
#SBATCH --job-name=pwcnet_sintel-clean_pcfa_i20
#SBATCH --output=slurm/pwcnet_sintel-clean_pcfa_i20_%A_%a.out
#SBATCH --error=slurm/pwcnet_sintel-clean_pcfa_i20_err_%A_%a.out
