...
#SBATCH --array=0-1%2
#SBATCH --job-name=maskflownet_s_sintel-clean_pcfa_i20
#SBATCH --output=slurm/maskflownet_s_sintel-clean_pcfa_i20.out
#SBATCH --error=slurm/maskflownet_s_sintel-clean_pcfa_i20_err_%A_%a.out
