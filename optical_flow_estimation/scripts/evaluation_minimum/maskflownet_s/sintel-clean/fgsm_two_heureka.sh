...
#SBATCH --job-name=maskflownet_s_sintel-clean_fgsm_i20_two
#SBATCH --output=slurm/maskflownet_s_sintel-clean_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/maskflownet_s_sintel-clean_fgsm_i20_two_err_%A_%a.out
