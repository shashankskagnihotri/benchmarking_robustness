...
#SBATCH --array=0-44%4
#SBATCH --job-name=maskflownet_s_sintel-clean_bim_pgd_cospgd_i10
#SBATCH --output=slurm/maskflownet_s_sintel-clean_bim_pgd_cospgd_i10_%A_%a.out
#SBATCH --error=slurm/maskflownet_s_sintel-clean_bim_pgd_cospgd_i10_err_%A_%a.out
