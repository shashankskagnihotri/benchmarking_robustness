...
#SBATCH --job-name=maskflownet_s_sintel-final_pcfa
#SBATCH --output=slurm/maskflownet_s_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/maskflownet_s_sintel-final_pcfa_err_%A_%a.out
