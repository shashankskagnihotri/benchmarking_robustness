...
#SBATCH --array=0-7%4
#SBATCH --job-name=maskflownet_s_sintel-final_3dcc
#SBATCH --output=slurm/maskflownet_s_sintel-final_3dcc_%A_%a.out
#SBATCH --error=slurm/maskflownet_s_sintel-final_3dcc_err_%A_%a.out
