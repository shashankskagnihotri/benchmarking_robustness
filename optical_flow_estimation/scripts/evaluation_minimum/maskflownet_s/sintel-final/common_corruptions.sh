...
#SBATCH --array=0-14%4
#SBATCH --job-name=maskflownet_s_sintel-final_cc
#SBATCH --output=slurm/maskflownet_s_sintel-final_cc_%A_%a.out
#SBATCH --error=slurm/maskflownet_s_sintel-final_cc_err_%A_%a.out
