...
#SBATCH --array=0-6%4
#SBATCH --job-name=liteflownet_kitti-2015_fgsm
#SBATCH --output=slurm/liteflownet_kitti-2015_fgsm_%A_%a.out
#SBATCH --error=slurm/liteflownet_kitti-2015_fgsm_err_%A_%a.out
