...
#SBATCH --array=0-7%4
#SBATCH --job-name=liteflownet_kitti-2015_3dcc
#SBATCH --output=slurm/liteflownet_kitti-2015_3dcc_%A_%a.out
#SBATCH --error=slurm/liteflownet_kitti-2015_3dcc_err_%A_%a.out
