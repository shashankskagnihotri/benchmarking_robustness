...
#SBATCH --array=0-14%4
#SBATCH --job-name=liteflownet_kitti-2015_cc
#SBATCH --output=slurm/liteflownet_kitti-2015_cc_%A_%a.out
#SBATCH --error=slurm/liteflownet_kitti-2015_cc_err_%A_%a.out
