...
#SBATCH --job-name=liteflownet_kitti-2015_pcfa
#SBATCH --output=slurm/liteflownet_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/liteflownet_kitti-2015_pcfa_err_%A_%a.out
