...
#SBATCH --array=0-1%2
#SBATCH --job-name=liteflownet_kitti-2015_pcfa_i20
#SBATCH --output=slurm/liteflownet_kitti-2015_pcfa_i20.out
#SBATCH --error=slurm/liteflownet_kitti-2015_pcfa_i20_err_%A_%a.out
