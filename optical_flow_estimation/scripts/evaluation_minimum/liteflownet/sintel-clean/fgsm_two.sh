...
#SBATCH --array=0-2%4
#SBATCH --job-name=liteflownet_sintel-clean_fgsm_two
#SBATCH --output=slurm/liteflownet_sintel-clean_fgsm_two_%A_%a.out
#SBATCH --error=slurm/liteflownet_sintel-clean_fgsm_two_err_%A_%a.out
