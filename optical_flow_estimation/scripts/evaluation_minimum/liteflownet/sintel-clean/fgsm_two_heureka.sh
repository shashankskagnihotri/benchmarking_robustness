...
#SBATCH --job-name=liteflownet_sintel-clean_fgsm_i20_two
#SBATCH --output=slurm/liteflownet_sintel-clean_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/liteflownet_sintel-clean_fgsm_i20_two_err_%A_%a.out
