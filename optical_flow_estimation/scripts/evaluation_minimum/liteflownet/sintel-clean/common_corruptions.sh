...
#SBATCH --array=0-14%4
#SBATCH --job-name=liteflownet_sintel-clean_cc
#SBATCH --output=slurm/liteflownet_sintel-clean_cc_%A_%a.out
#SBATCH --error=slurm/liteflownet_sintel-clean_cc_err_%A_%a.out
