...
#SBATCH --job-name=liteflownet_sintel-final_pcfa
#SBATCH --output=slurm/liteflownet_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/liteflownet_sintel-final_pcfa_err_%A_%a.out
