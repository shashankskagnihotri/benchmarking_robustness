...
#SBATCH --array=0-6%4
#SBATCH --job-name=flowformer_sintel-clean_fgsm
#SBATCH --output=slurm/flowformer_sintel-clean_fgsm_%A_%a.out
#SBATCH --error=slurm/flowformer_sintel-clean_fgsm_err_%A_%a.out
