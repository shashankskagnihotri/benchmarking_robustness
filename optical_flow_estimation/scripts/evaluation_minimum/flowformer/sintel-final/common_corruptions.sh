...
#SBATCH --array=0-74%4
#SBATCH --job-name=flowformer_sintel-final_cc
#SBATCH --output=slurm/flowformer_sintel-final_cc_%A_%a.out
#SBATCH --error=slurm/flowformer_sintel-final_cc_err_%A_%a.out
