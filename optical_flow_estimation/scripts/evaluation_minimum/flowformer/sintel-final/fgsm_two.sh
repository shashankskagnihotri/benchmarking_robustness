...
#SBATCH --array=0-2%2
#SBATCH --job-name=flowformer_sintel-final_fgsm_two
#SBATCH --output=slurm/flowformer_sintel-final_fgsm_two_%A_%a.out
#SBATCH --error=slurm/flowformer_sintel-final_fgsm_two_err_%A_%a.out
