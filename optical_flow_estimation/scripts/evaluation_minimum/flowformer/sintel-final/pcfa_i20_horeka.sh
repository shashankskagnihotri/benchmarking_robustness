...
#SBATCH --job-name=flowformer_sintel-final_pcfa
#SBATCH --output=slurm/flowformer_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/flowformer_sintel-final_pcfa_err_%A_%a.out
