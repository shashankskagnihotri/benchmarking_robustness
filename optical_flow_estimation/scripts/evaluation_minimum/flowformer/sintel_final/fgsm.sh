...
#SBATCH --array=0-14%4
#SBATCH --job-name=flowformer_sintel-final_fgsm
#SBATCH --output=slurm/flowformer_sintel-final_fgsm_%A_%a.out
#SBATCH --error=slurm/flowformer_sintel-final_fgsm_err_%A_%a.out
