...
#SBATCH --job-name=flowformer_kitti-2015_pcfa
#SBATCH --output=slurm/flowformer_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/flowformer_kitti-2015_pcfa_err_%A_%a.out
