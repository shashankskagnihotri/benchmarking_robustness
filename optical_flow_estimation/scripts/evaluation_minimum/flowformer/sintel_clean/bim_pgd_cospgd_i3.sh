...
#SBATCH --array=0-35%4
#SBATCH --job-name=flowformer_sintel-clean_bim_pgd_cospgd_i3
#SBATCH --output=slurm/flowformer_sintel-clean_bim_pgd_cospgd_i3_%A_%a.out
#SBATCH --error=slurm/flowformer_sintel-clean_bim_pgd_cospgd_i3_err_%A_%a.out
