...
#SBATCH --array=0-35%4
#SBATCH --job-name=dicl_sintel-final_bim_pgd_cospgd_i20
#SBATCH --output=slurm/dicl_sintel-final_bim_pgd_cospgd_i20_%A_%a.out
#SBATCH --error=slurm/dicl_sintel-final_bim_pgd_cospgd_i20_err_%A_%a.out
