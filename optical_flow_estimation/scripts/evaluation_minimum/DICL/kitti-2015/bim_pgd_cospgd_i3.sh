...
#SBATCH --array=0-35%4
#SBATCH --job-name=dicl_kitti-2015_bim_pgd_cospgd_i3
#SBATCH --output=slurm/dicl_kitti-2015_bim_pgd_cospgd_i3_%A_%a.out
#SBATCH --error=slurm/dicl_kitti-2015_bim_pgd_cospgd_i3_err_%A_%a.out
