...
#SBATCH --array=0-2%4
#SBATCH --job-name=rpknet_sintel-clean_fgsm_two
#SBATCH --output=slurm/rpknet_sintel-clean_fgsm_two_%A_%a.out
#SBATCH --error=slurm/rpknet_sintel-clean_fgsm_two_err_%A_%a.out
