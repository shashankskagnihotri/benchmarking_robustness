...
#SBATCH --array=0-3%4
#SBATCH --job-name=rpknet_kitti-2015_fgsm_inf
#SBATCH --output=slurm/rpknet_kitti-2015_fgsm_inf_%A_%a.out
#SBATCH --error=slurm/rpknet_kitti-2015_fgsm_inf_err_%A_%a.out
