...
#SBATCH --array=0-1%2
#SBATCH --job-name=rpknet_kitti-2015_pgd_cospgd_i20_inf_init
#SBATCH --output=slurm/rpknet_kitti-2015_pgd_cospgd_i20_inf_init_%A_%a.out
#SBATCH --error=slurm/rpknet_kitti-2015_pgd_cospgd_i20_inf_init_err_%A_%a.out
