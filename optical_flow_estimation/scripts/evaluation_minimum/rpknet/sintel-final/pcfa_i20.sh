...
#SBATCH --array=0-1%2
#SBATCH --job-name=rpknet_sintel-final_pcfa_i20
#SBATCH --output=slurm/rpknet_sintel-final_pcfa_i20.out
#SBATCH --error=slurm/rpknet_sintel-final_pcfa_i20_err_%A_%a.out
