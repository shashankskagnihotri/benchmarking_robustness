...
#SBATCH --array=0-2%2
#SBATCH --job-name=rpknet_sintel-final_fgsm_two
#SBATCH --output=slurm/rpknet_sintel-final_fgsm_two_%A_%a.out
#SBATCH --error=slurm/rpknet_sintel-final_fgsm_two_err_%A_%a.out
