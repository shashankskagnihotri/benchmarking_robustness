...
#SBATCH --job-name=rpknet_sintel-final_pcfa
#SBATCH --output=slurm/rpknet_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/rpknet_sintel-final_pcfa_err_%A_%a.out
