...
#SBATCH --job-name=rpknet_sintel-final_fgsm_i20_two
#SBATCH --output=slurm/rpknet_sintel-final_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/rpknet_sintel-final_fgsm_i20_two_err_%A_%a.out
