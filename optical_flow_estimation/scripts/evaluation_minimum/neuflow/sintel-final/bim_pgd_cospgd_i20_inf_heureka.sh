...
#SBATCH --job-name=neuflow_sintel-final_bim_pgd_cospgd_i20_inf
#SBATCH --output=slurm/neuflow_sintel-final_bim_pgd_cospgd_i20_inf_%A_%a.out
#SBATCH --error=slurm/neuflow_sintel-final_bim_pgd_cospgd_i20_inf_err_%A_%a.out
#SBATCH --array=0-2%3
