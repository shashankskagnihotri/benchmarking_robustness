...
#SBATCH --job-name=irr_pwc_sintel-final_fgsm_i20_inf
#SBATCH --output=slurm/irr_pwc_sintel-final_fgsm_i20_inf_%A_%a.out
#SBATCH --error=slurm/irr_pwc_sintel-final_fgsm_i20_inf_err_%A_%a.out
