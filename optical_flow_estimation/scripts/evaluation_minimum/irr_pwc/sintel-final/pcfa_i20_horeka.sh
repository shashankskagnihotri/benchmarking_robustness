...
#SBATCH --job-name=irr_pwc_sintel-final_pcfa
#SBATCH --output=slurm/irr_pwc_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/irr_pwc_sintel-final_pcfa_err_%A_%a.out
