...
#SBATCH --array=0-1%2
#SBATCH --job-name=irr_pwc_sintel-final_pcfa_i20
#SBATCH --output=slurm/irr_pwc_sintel-final_pcfa_i20.out
#SBATCH --error=slurm/irr_pwc_sintel-final_pcfa_i20_err_%A_%a.out
