...
#SBATCH --job-name=irr_pwc_sintel-final_fgsm_i20_two
#SBATCH --output=slurm/irr_pwc_sintel-final_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/irr_pwc_sintel-final_fgsm_i20_two_err_%A_%a.out
