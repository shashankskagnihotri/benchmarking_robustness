...
#SBATCH --array=0-7%4
#SBATCH --job-name=irr_pwc_sintel-clean_3dcc
#SBATCH --output=slurm/irr_pwc_sintel-clean_3dcc_%A_%a.out
#SBATCH --error=slurm/irr_pwc_sintel-clean_3dcc_err_%A_%a.out
