...
#SBATCH --array=0-6%4
#SBATCH --job-name=irr_pwc_sintel-clean_fgsm
#SBATCH --output=slurm/irr_pwc_sintel-clean_fgsm_%A_%a.out
#SBATCH --error=slurm/irr_pwc_sintel-clean_fgsm_err_%A_%a.out
