...
#SBATCH --array=0-8%4
#SBATCH --job-name=irr_pwc_sintel-clean_bim_pgd_cospgd_i20_two
#SBATCH --output=slurm/irr_pwc_sintel-clean_bim_pgd_cospgd_i20_two_%A_%a.out
#SBATCH --error=slurm/irr_pwc_sintel-clean_bim_pgd_cospgd_i20_two_err_%A_%a.out
