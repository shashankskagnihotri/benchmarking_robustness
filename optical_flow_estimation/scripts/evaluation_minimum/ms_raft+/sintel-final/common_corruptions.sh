...
#SBATCH --array=0-74%4
#SBATCH --job-name=ms_raft+_sintel-final_cc
#SBATCH --output=slurm/ms_raft+_sintel-final_cc_%A_%a.out
#SBATCH --error=slurm/ms_raft+_sintel-final_cc_err_%A_%a.out
