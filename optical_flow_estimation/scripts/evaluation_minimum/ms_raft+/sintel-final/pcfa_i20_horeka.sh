...
#SBATCH --job-name=ms_raft+_sintel-final_pcfa
#SBATCH --output=slurm/ms_raft+_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/ms_raft+_sintel-final_pcfa_err_%A_%a.out
