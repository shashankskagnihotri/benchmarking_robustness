...
#SBATCH --job-name=ms_raft+_kitti-2015_pcfa
#SBATCH --output=slurm/ms_raft+_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/ms_raft+_kitti-2015_pcfa_err_%A_%a.out
