...
#SBATCH --array=0-1%2
#SBATCH --job-name=ms_raft+_kitti-2015_pcfa_i20
#SBATCH --output=slurm/ms_raft+_kitti-2015_pcfa_i20.out
#SBATCH --error=slurm/ms_raft+_kitti-2015_pcfa_i20_err_%A_%a.out
