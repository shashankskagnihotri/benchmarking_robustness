...
#SBATCH --array=0-7%4
#SBATCH --job-name=ms_raft+_kitti-2015_3dcc
#SBATCH --output=slurm/ms_raft+_kitti-2015_3dcc_%A_%a.out
#SBATCH --error=slurm/ms_raft+_kitti-2015_3dcc_err_%A_%a.out
