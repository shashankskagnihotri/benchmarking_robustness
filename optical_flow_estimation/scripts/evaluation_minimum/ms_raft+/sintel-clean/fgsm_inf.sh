...
#SBATCH --array=0-3%4
#SBATCH --job-name=ms_raft+_sintel-clean_fgsm_inf
#SBATCH --output=slurm/ms_raft+_sintel-clean_fgsm_inf_%A_%a.out
#SBATCH --error=slurm/ms_raft+_sintel-clean_fgsm_inf_err_%A_%a.out
