...
#SBATCH --array=0-14%4
#SBATCH --job-name=ms_raft+_sintel-clean_cc
#SBATCH --output=slurm/ms_raft+_sintel-clean_cc_%A_%a.out
#SBATCH --error=slurm/ms_raft+_sintel-clean_cc_err_%A_%a.out
