...
#SBATCH --job-name=ms_raft+_sintel-clean_fgsm_i20_inf
#SBATCH --output=slurm/ms_raft+_sintel-clean_fgsm_i20_inf_%A_%a.out
#SBATCH --error=slurm/ms_raft+_sintel-clean_fgsm_i20_inf_err_%A_%a.out
