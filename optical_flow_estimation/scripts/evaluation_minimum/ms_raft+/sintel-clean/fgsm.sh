...
#SBATCH --array=0-6%4
#SBATCH --job-name=ms_raft+_sintel-clean_fgsm
#SBATCH --output=slurm/ms_raft+_sintel-clean_fgsm_%A_%a.out
#SBATCH --error=slurm/ms_raft+_sintel-clean_fgsm_err_%A_%a.out
