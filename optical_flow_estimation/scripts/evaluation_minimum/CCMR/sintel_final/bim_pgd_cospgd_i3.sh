...
#SBATCH --array=0-35%4
#SBATCH --job-name=ccmr_sintel-final_bim_pgd_cospgd_i3
#SBATCH --output=slurm/ccmr_sintel-final_bim_pgd_cospgd_i3_%A_%a.out
#SBATCH --error=slurm/ccmr_sintel-final_bim_pgd_cospgd_i3_err_%A_%a.out
