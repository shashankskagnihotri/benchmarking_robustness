...
#SBATCH --array=0-6%4
#SBATCH --job-name=matchflow_sintel-clean_fgsm
#SBATCH --output=slurm/matchflow_sintel-clean_fgsm_%A_%a.out
#SBATCH --error=slurm/matchflow_sintel-clean_fgsm_err_%A_%a.out
