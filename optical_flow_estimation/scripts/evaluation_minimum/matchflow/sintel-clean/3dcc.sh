...
#SBATCH --array=0-7%4
#SBATCH --job-name=matchflow_sintel-clean_3dcc
#SBATCH --output=slurm/matchflow_sintel-clean_3dcc_%A_%a.out
#SBATCH --error=slurm/matchflow_sintel-clean_3dcc_err_%A_%a.out
