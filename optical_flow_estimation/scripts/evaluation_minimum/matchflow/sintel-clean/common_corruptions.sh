...
#SBATCH --array=0-14%4
#SBATCH --job-name=matchflow_sintel-clean_cc
#SBATCH --output=slurm/matchflow_sintel-clean_cc_%A_%a.out
#SBATCH --error=slurm/matchflow_sintel-clean_cc_err_%A_%a.out
