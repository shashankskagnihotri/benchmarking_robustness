...
#SBATCH --array=0-3%4
#SBATCH --job-name=matchflow_sintel-clean_fgsm_inf
#SBATCH --output=slurm/matchflow_sintel-clean_fgsm_inf_%A_%a.out
#SBATCH --error=slurm/matchflow_sintel-clean_fgsm_inf_err_%A_%a.out
