...
#SBATCH --array=0-74%4
#SBATCH --job-name=matchflow_sintel-final_cc
#SBATCH --output=slurm/matchflow_sintel-final_cc_%A_%a.out
#SBATCH --error=slurm/matchflow_sintel-final_cc_err_%A_%a.out
