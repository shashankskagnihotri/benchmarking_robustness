...
#SBATCH --job-name=matchflow_sintel-final_pcfa
#SBATCH --output=slurm/matchflow_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/matchflow_sintel-final_pcfa_err_%A_%a.out
