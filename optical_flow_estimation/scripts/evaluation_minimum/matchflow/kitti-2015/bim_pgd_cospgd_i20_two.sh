...
#SBATCH --array=0-8%4
#SBATCH --job-name=matchflow_kitti-2015_bim_pgd_cospgd_i20_two
#SBATCH --output=slurm/matchflow_kitti-2015_bim_pgd_cospgd_i20_two_%A_%a.out
#SBATCH --error=slurm/matchflow_kitti-2015_bim_pgd_cospgd_i20_two_err_%A_%a.out
