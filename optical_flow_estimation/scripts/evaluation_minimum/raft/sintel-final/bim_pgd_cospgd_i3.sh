...
#SBATCH --array=0-44%4
#SBATCH --job-name=raft_sintel-final_bim_pgd_cospgd_i3
#SBATCH --output=slurm/raft_sintel-final_bim_pgd_cospgd_i3_%A_%a.out
#SBATCH --error=slurm/raft_sintel-final_bim_pgd_cospgd_i3_err_%A_%a.out
