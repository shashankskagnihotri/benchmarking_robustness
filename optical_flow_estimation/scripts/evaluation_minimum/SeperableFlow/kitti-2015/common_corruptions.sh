...
#SBATCH --array=0-74%4
#SBATCH --job-name=separableflow_kitti-2015_cc
#SBATCH --output=slurm/separableflow_kitti-2015_cc_%A_%a.out
#SBATCH --error=slurm/separableflow_kitti-2015_cc_err_%A_%a.out
