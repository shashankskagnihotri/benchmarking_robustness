...
#SBATCH --array=0-1%2
#SBATCH --job-name=dicl_sintel-clean_pcfa_i10
#SBATCH --output=slurm/dicl_sintel-clean_pcfa_i10_%A_%a.out
#SBATCH --error=slurm/dicl_sintel-clean_pcfa_i10_err_%A_%a.out
