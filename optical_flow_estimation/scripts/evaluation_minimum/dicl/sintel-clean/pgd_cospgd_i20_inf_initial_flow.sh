...
#SBATCH --array=0-1%2
#SBATCH --job-name=dicl_sintel-clean_pgd_cospgd_i20_inf_init
#SBATCH --output=slurm/dicl_sintel-clean_pgd_cospgd_i20_inf_init_%A_%a.out
#SBATCH --error=slurm/dicl_sintel-clean_pgd_cospgd_i20_inf_init_err_%A_%a.out
