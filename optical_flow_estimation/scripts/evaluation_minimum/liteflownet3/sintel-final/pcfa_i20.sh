...
#SBATCH --array=0-1%2
#SBATCH --job-name=liteflownet3_sintel-final_pcfa_i20
#SBATCH --output=slurm/liteflownet3_sintel-final_pcfa_i20.out
#SBATCH --error=slurm/liteflownet3_sintel-final_pcfa_i20_err_%A_%a.out
