...
#SBATCH --job-name=memflow_sintel-final_pcfa
#SBATCH --output=slurm/memflow_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/memflow_sintel-final_pcfa_err_%A_%a.out
