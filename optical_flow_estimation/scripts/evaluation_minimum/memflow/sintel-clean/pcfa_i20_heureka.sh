...
#SBATCH --job-name=memflow_sintel-clean_pcfa
#SBATCH --output=slurm/memflow_sintel-clean_pcfa_%A_%a.out
#SBATCH --error=slurm/memflow_sintel-clean_pcfa_err_%A_%a.out
