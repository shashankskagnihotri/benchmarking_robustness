...
#SBATCH --array=0-11%4
#SBATCH --job-name=ccmr_kitti-2015_bim_pgd_cospgd_i20_inf
#SBATCH --output=slurm/ccmr_kitti-2015_bim_pgd_cospgd_i20_inf_%A_%a.out
#SBATCH --error=slurm/ccmr_kitti-2015_bim_pgd_cospgd_i20_inf_err_%A_%a.out
