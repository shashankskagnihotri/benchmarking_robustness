...
#SBATCH --job-name=dip_sintel-clean_fgsm_i20_two
#SBATCH --output=slurm/dip_sintel-clean_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/dip_sintel-clean_fgsm_i20_two_err_%A_%a.out
