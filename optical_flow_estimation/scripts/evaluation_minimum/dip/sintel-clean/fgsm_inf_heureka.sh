...
#SBATCH --job-name=dip_sintel-clean_fgsm_i20_inf
#SBATCH --output=slurm/dip_sintel-clean_fgsm_i20_inf_%A_%a.out
#SBATCH --error=slurm/dip_sintel-clean_fgsm_i20_inf_err_%A_%a.out
