...
#SBATCH --array=0-44%4
#SBATCH --job-name=dip_sintel-final_bim_pgd_cospgd_i10
#SBATCH --output=slurm/dip_sintel-final_bim_pgd_cospgd_i10_%A_%a.out
#SBATCH --error=slurm/dip_sintel-final_bim_pgd_cospgd_i10_err_%A_%a.out
