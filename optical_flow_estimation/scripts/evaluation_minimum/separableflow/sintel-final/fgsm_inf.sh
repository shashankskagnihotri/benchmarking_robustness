...
#SBATCH --array=0-3%4
#SBATCH --job-name=seperableflow_sintel-final_fgsm_inf
#SBATCH --output=slurm/seperableflow_sintel-final_fgsm_inf_%A_%a.out
#SBATCH --error=slurm/seperableflow_sintel-final_fgsm_inf_err_%A_%a.out
