...
#SBATCH --job-name=separableflow_kitti-2015_pcfa
#SBATCH --output=slurm/separableflow_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/separableflow_kitti-2015_pcfa_err_%A_%a.out
