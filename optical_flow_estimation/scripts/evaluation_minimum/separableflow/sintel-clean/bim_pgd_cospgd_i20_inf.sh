...
#SBATCH --array=0-11%4
#SBATCH --job-name=separableflow_sintel-clean_bim_pgd_cospgd_i20_inf
#SBATCH --output=slurm/separableflow_sintel-clean_bim_pgd_cospgd_i20_inf_%A_%a.out
#SBATCH --error=slurm/separableflow_sintel-clean_bim_pgd_cospgd_i20_inf_err_%A_%a.out
