...
#SBATCH --array=0-20%4
#SBATCH --job-name=separableflow_sintel-clean_bim_pgd_cospgd_i20
#SBATCH --output=slurm/separableflow_sintel-clean_bim_pgd_cospgd_i20_%A_%a.out
#SBATCH --error=slurm/separableflow_sintel-clean_bim_pgd_cospgd_i20_err_%A_%a.out
