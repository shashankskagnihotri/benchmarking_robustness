...
#SBATCH --job-name=gma_kitti-2015_pcfa_i20_255
#SBATCH --output=slurm/gma_kitti-2015_pcfa_i20_255_%A.out
#SBATCH --error=slurm/gma_kitti-2015_pcfa_i20_err_255_%A.out
