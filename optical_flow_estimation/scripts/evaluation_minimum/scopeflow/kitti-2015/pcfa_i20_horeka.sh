...
#SBATCH --job-name=scopeflow_kitti-2015_pcfa
#SBATCH --output=slurm/scopeflow_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/scopeflow_kitti-2015_pcfa_err_%A_%a.out
