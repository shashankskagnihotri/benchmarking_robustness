...
#SBATCH --job-name=scopeflow_kitti-2015_bim_pgd_cospgd_i20_inf
#SBATCH --output=slurm/scopeflow_kitti-2015_bim_pgd_cospgd_i20_inf_%A_%a.out
#SBATCH --error=slurm/scopeflow_kitti-2015_bim_pgd_cospgd_i20_inf_err_%A_%a.out
#SBATCH --array=0-2%3
