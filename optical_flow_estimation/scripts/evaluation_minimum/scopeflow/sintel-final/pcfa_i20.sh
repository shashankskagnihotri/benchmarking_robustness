...
#SBATCH --array=0-1%2
#SBATCH --job-name=scopeflow_sintel-final_pcfa_i20
#SBATCH --output=slurm/scopeflow_sintel-final_pcfa_i20.out
#SBATCH --error=slurm/scopeflow_sintel-final_pcfa_i20_err_%A_%a.out
