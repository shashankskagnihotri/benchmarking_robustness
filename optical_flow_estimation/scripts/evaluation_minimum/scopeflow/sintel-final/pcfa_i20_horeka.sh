...
#SBATCH --job-name=scopeflow_sintel-final_pcfa
#SBATCH --output=slurm/scopeflow_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/scopeflow_sintel-final_pcfa_err_%A_%a.out
