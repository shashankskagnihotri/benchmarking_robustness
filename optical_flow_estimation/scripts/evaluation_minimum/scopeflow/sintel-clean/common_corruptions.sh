...
#SBATCH --array=0-14%4
#SBATCH --job-name=scopeflow_sintel-clean_cc
#SBATCH --output=slurm/scopeflow_sintel-clean_cc_%A_%a.out
#SBATCH --error=slurm/scopeflow_sintel-clean_cc_err_%A_%a.out
