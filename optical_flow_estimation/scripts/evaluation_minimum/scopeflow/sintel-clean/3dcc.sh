...
#SBATCH --array=0-7%4
#SBATCH --job-name=scopeflow_sintel-clean_3dcc
#SBATCH --output=slurm/scopeflow_sintel-clean_3dcc_%A_%a.out
#SBATCH --error=slurm/scopeflow_sintel-clean_3dcc_err_%A_%a.out
