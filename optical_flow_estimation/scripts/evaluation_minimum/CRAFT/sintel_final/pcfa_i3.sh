...
#SBATCH --array=0-1%2
#SBATCH --job-name=craft_sintel-final_pcfa_i3
#SBATCH --output=slurm/craft_sintel-final_pcfa_i3_%A_%a.out
#SBATCH --error=slurm/craft_sintel-final_pcfa_i3_err_%A_%a.out
