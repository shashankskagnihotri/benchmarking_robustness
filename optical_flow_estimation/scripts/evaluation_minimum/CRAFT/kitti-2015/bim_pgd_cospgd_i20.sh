...
#SBATCH --array=0-44%4
#SBATCH --job-name=craft_kitti-2015_bim_pgd_cospgd_i20
#SBATCH --output=slurm/craft_kitti-2015_bim_pgd_cospgd_i20_%A_%a.out
#SBATCH --error=slurm/craft_kitti-2015_bim_pgd_cospgd_i20_err_%A_%a.out
