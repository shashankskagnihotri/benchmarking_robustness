...
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4a100
#SBATCH --array=0-35%4
#SBATCH --job-name=craft_kitti-2015_bim_pgd_cospgd_i3
#SBATCH --output=slurm/craft_kitti-2015_bim_pgd_cospgd_i3_%A_%a.out
#SBATCH --error=slurm/craft_kitti-2015_bim_pgd_cospgd_i3_err_%A_%a.out
