...
#SBATCH --job-name=splatflow_kitti-2015_pcfa
#SBATCH --output=slurm/splatflow_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/splatflow_kitti-2015_pcfa_err_%A_%a.out
