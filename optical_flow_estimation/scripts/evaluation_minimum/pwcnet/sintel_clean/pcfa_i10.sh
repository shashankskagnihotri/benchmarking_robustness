...
#SBATCH --array=0-1%2
#SBATCH --job-name=pwcnet_sintel-clean_pcfa_i10
#SBATCH --output=slurm/pwcnet_sintel-clean_pcfa_i10_%A_%a.out
#SBATCH --error=slurm/pwcnet_sintel-clean_pcfa_i10_err_%A_%a.out
