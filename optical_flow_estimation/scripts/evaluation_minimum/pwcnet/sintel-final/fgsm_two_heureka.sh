...
#SBATCH --job-name=pwcnet_sintel-final_fgsm_i20_two
#SBATCH --output=slurm/pwcnet_sintel-final_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/pwcnet_sintel-final_fgsm_i20_two_err_%A_%a.out
