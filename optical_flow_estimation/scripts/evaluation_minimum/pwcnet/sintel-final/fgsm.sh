...
#SBATCH --array=0-6%4
#SBATCH --job-name=pwcnet_sintel-final_fgsm
#SBATCH --output=slurm/pwcnet_sintel-final_fgsm_%A_%a.out
#SBATCH --error=slurm/pwcnet_sintel-final_fgsm_err_%A_%a.out
