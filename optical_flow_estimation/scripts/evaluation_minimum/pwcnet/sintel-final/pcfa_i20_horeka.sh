...
#SBATCH --job-name=pwcnet_sintel-final_pcfa
#SBATCH --output=slurm/pwcnet_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/pwcnet_sintel-final_pcfa_err_%A_%a.out
