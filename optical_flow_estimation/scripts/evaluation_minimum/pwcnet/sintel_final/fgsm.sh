...
#SBATCH --array=0-14%4
#SBATCH --job-name=pwcnet_sintel-clean_fgsm
#SBATCH --output=slurm/pwcnet_sintel-clean_fgsm_%A_%a.out
#SBATCH --error=slurm/pwcnet_sintel-clean_fgsm_err_%A_%a.out
