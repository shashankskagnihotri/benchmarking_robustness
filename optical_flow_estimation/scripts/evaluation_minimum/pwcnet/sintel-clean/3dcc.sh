...
#SBATCH --array=0-7%4
#SBATCH --job-name=pwcnet_sintel-clean_3dcc
#SBATCH --output=slurm/pwcnet_sintel-clean_3dcc_%A_%a.out
#SBATCH --error=slurm/pwcnet_sintel-clean_3dcc_err_%A_%a.out
