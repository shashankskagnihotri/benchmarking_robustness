...
#SBATCH --job-name=pwcnet_kitti-2015_pcfa_i20
#SBATCH --output=slurm/pwcnet_kitti-2015_pcfa_sintel_test_001_%A.out
#SBATCH --error=slurm/pwcnet_kitti-2015_pcfa_sintel_test_001_err_%A.out
