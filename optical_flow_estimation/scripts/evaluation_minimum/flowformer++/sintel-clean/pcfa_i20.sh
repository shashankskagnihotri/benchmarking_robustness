...
#SBATCH --array=0-1%2
#SBATCH --job-name=flowformer++_sintel-clean_pcfa_i20
#SBATCH --output=slurm/flowformer++_sintel-clean_pcfa_i20.out
#SBATCH --error=slurm/flowformer++_sintel-clean_pcfa_i20_err_%A_%a.out
