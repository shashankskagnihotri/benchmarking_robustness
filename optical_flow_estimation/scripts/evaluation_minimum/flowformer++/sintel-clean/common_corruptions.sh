...
#SBATCH --array=0-74%4
#SBATCH --job-name=flowformer++_sintel-clean_cc
#SBATCH --output=slurm/flowformer++_sintel-clean_cc_%A_%a.out
#SBATCH --error=slurm/flowformer++_sintel-clean_cc_err_%A_%a.out
