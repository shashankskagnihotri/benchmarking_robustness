...
#SBATCH --job-name=flowformer++_sintel-final_pcfa
#SBATCH --output=slurm/flowformer++_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/flowformer++_sintel-final_pcfa_err_%A_%a.out
