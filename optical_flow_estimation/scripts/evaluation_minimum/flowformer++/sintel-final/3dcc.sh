...
#SBATCH --array=0-7%4
#SBATCH --job-name=flowformer++_sintel-final_3dcc
#SBATCH --output=slurm/flowformer++_sintel-final_3dcc_%A_%a.out
#SBATCH --error=slurm/flowformer++_sintel-final_3dcc_err_%A_%a.out
