...
#SBATCH --array=0-6%4
#SBATCH --job-name=flowformer++_sintel-final_fgsm
#SBATCH --output=slurm/flowformer++_sintel-final_fgsm_%A_%a.out
#SBATCH --error=slurm/flowformer++_sintel-final_fgsm_err_%A_%a.out
