...
#SBATCH --ntasks=1
#SBATCH --mem=100G
#SBATCH --time=04:44:59
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4_a100
#SBATCH --array=0-2%2
#SBATCH --job-name=flowformer++_sintel-final_fgsm_two
#SBATCH --output=slurm/flowformer++_sintel-final_fgsm_two_%A_%a.out
#SBATCH --error=slurm/flowformer++_sintel-final_fgsm_two_err_%A_%a.out
