...
#SBATCH --array=0-74%4
#SBATCH --job-name=flowformer++_kitti-2015_cc
#SBATCH --output=slurm/flowformer++_kitti-2015_cc_%A_%a.out
#SBATCH --error=slurm/flowformer++_kitti-2015_cc_err_%A_%a.out
