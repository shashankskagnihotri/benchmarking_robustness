...
#SBATCH --array=0-6%4
#SBATCH --job-name=flowformer++_kitti-2015_fgsm
#SBATCH --output=slurm/flowformer++_kitti-2015_fgsm_%A_%a.out
#SBATCH --error=slurm/flowformer++_kitti-2015_fgsm_err_%A_%a.out
