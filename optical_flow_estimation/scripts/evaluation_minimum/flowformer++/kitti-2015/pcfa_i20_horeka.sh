...
#SBATCH --job-name=flowformer++_kitti-2015_pcfa
#SBATCH --output=slurm/flowformer++_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/flowformer++_kitti-2015_pcfa_err_%A_%a.out
