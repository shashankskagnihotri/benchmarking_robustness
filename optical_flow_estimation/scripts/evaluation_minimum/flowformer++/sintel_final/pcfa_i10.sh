...
#SBATCH --array=0-1%2
#SBATCH --job-name=flowformer++_sintel-final_pcfa_i10
#SBATCH --output=slurm/flowformer++_sintel-final_pcfa_i10_%A_%a.out
#SBATCH --error=slurm/flowformer++_sintel-final_pcfa_i10_err_%A_%a.out
