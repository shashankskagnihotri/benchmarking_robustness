...
#SBATCH --array=0-1%2
#SBATCH --job-name=flowformer++_sintel-clean_pcfa_i10
#SBATCH --output=slurm/flowformer++_sintel-clean_pcfa_i10_%A_%a.out
#SBATCH --error=slurm/flowformer++_sintel-clean_pcfa_i10_err_%A_%a.out
