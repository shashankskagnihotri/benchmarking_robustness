...
#SBATCH --array=0-1%2
#SBATCH --job-name=flowformer++_sintel-clean_pcfa_i3
#SBATCH --output=slurm/flowformer++_sintel-clean_pcfa_i3_%A_%a.out
#SBATCH --error=slurm/flowformer++_sintel-clean_pcfa_i3_err_%A_%a.out
