...
#SBATCH --array=0-1%2
#SBATCH --job-name=starflow_sintel-final_pcfa_i20
#SBATCH --output=slurm/starflow_sintel-final_pcfa_i20.out
#SBATCH --error=slurm/starflow_sintel-final_pcfa_i20_err_%A_%a.out
