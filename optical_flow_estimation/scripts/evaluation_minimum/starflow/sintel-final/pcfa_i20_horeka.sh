...
#SBATCH --job-name=starflow_sintel-final_pcfa
#SBATCH --output=slurm/starflow_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/starflow_sintel-final_pcfa_err_%A_%a.out
