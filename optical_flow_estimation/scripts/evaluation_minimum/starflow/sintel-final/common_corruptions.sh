...
#SBATCH --array=0-14%4
#SBATCH --job-name=starflow_sintel-final_cc
#SBATCH --output=slurm/starflow_sintel-final_cc_%A_%a.out
#SBATCH --error=slurm/starflow_sintel-final_cc_err_%A_%a.out
