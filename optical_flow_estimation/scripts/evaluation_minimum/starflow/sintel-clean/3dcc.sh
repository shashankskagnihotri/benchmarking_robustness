...
#SBATCH --array=0-7%4
#SBATCH --job-name=starflow_sintel-clean_3dcc
#SBATCH --output=slurm/starflow_sintel-clean_3dcc_%A_%a.out
#SBATCH --error=slurm/starflow_sintel-clean_3dcc_err_%A_%a.out
