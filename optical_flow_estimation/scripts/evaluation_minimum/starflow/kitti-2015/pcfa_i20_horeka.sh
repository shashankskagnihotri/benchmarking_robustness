...
#SBATCH --job-name=starflow_kitti-2015_pcfa
#SBATCH --output=slurm/starflow_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/starflow_kitti-2015_pcfa_err_%A_%a.out
