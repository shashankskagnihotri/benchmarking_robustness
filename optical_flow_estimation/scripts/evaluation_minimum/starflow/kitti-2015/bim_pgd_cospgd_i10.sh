...
#SBATCH --array=0-35%4
#SBATCH --job-name=starflow_kitti-2015_bim_pgd_cospgd_i10
#SBATCH --output=slurm/starflow_kitti-2015_bim_pgd_cospgd_i10_%A_%a.out
#SBATCH --error=slurm/starflow_kitti-2015_bim_pgd_cospgd_i10_err_%A_%a.out
