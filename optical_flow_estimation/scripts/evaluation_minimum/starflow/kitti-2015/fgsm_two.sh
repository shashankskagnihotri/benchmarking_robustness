...
#SBATCH --array=0-2%2
#SBATCH --job-name=starflow_kitti-2015_fgsm_two
#SBATCH --output=slurm/starflow_kitti-2015_fgsm_two_%A_%a.out
#SBATCH --error=slurm/starflow_kitti-2015_fgsm_two_err_%A_%a.out
