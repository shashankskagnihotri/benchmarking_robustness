...
#SBATCH --job-name=starflow_kitti-2015_fgsm_i20_inf
#SBATCH --output=slurm/starflow_kitti-2015_fgsm_i20_inf_%A_%a.out
#SBATCH --error=slurm/starflow_kitti-2015_fgsm_i20_inf_err_%A_%a.out
