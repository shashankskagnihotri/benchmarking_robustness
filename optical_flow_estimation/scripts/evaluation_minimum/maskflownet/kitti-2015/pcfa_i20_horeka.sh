...
#SBATCH --job-name=maskflownet_kitti-2015_pcfa
#SBATCH --output=slurm/maskflownet_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/maskflownet_kitti-2015_pcfa_err_%A_%a.out
