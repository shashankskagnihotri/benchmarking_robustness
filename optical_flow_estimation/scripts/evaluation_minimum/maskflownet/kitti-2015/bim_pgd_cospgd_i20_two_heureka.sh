...
#SBATCH --job-name=maskflownet_kitti-2015_bim_pgd_cospgd_i20_two
#SBATCH --output=slurm/maskflownet_kitti-2015_bim_pgd_cospgd_i20_two_%A_%a.out
#SBATCH --error=slurm/maskflownet_kitti-2015_bim_pgd_cospgd_i20_two_err_%A_%a.out
#SBATCH --array=0-1%4
