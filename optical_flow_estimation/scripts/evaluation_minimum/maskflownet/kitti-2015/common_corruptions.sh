...
#SBATCH --array=0-14%4
#SBATCH --job-name=maskflownet_kitti-2015_cc
#SBATCH --output=slurm/maskflownet_kitti-2015_cc_%A_%a.out
#SBATCH --error=slurm/maskflownet_kitti-2015_cc_err_%A_%a.out
