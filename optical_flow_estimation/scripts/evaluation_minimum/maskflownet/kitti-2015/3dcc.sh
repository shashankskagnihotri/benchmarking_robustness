...
#SBATCH --array=0-7%4
#SBATCH --job-name=maskflownet_kitti-2015_3dcc
#SBATCH --output=slurm/maskflownet_kitti-2015_3dcc_%A_%a.out
#SBATCH --error=slurm/maskflownet_kitti-2015_3dcc_err_%A_%a.out
