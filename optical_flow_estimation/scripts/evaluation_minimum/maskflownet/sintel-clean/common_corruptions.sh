...
#SBATCH --array=0-74%4
#SBATCH --job-name=maskflownet_sintel-clean_cc
#SBATCH --output=slurm/maskflownet_sintel-clean_cc_%A_%a.out
#SBATCH --error=slurm/maskflownet_sintel-clean_cc_err_%A_%a.out
