...
#SBATCH --array=0-8%4
#SBATCH --job-name=liteflownet2_sintel-final_bim_pgd_cospgd_i20_two
#SBATCH --output=slurm/liteflownet2_sintel-final_bim_pgd_cospgd_i20_two_%A_%a.out
#SBATCH --error=slurm/liteflownet2_sintel-final_bim_pgd_cospgd_i20_two_err_%A_%a.out
