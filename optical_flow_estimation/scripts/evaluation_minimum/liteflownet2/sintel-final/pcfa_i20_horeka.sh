...
#SBATCH --job-name=liteflownet2_sintel-final_pcfa
#SBATCH --output=slurm/liteflownet2_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/liteflownet2_sintel-final_pcfa_err_%A_%a.out
