...
#SBATCH --job-name=liteflownet2_sintel-clean_fgsm_i20_inf
#SBATCH --output=slurm/liteflownet2_sintel-clean_fgsm_i20_inf_%A_%a.out
#SBATCH --error=slurm/liteflownet2_sintel-clean_fgsm_i20_inf_err_%A_%a.out
