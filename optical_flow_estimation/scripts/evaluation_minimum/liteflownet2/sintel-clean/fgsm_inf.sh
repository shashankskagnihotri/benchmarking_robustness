...
#SBATCH --array=0-3%4
#SBATCH --job-name=liteflownet2_sintel-clean_fgsm_inf
#SBATCH --output=slurm/liteflownet2_sintel-clean_fgsm_inf_%A_%a.out
#SBATCH --error=slurm/liteflownet2_sintel-clean_fgsm_inf_err_%A_%a.out
