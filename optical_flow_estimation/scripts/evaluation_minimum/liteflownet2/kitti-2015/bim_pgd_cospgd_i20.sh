...
#SBATCH --array=0-20%4
#SBATCH --job-name=liteflownet2_kitti-2015_bim_pgd_cospgd_i20
#SBATCH --output=slurm/liteflownet2_kitti-2015_bim_pgd_cospgd_i20_%A_%a.out
#SBATCH --error=slurm/liteflownet2_kitti-2015_bim_pgd_cospgd_i20_err_%A_%a.out
