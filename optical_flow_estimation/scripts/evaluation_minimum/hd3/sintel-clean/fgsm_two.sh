...
#SBATCH --array=0-2%4
#SBATCH --job-name=hd3_sintel-clean_fgsm_two
#SBATCH --output=slurm/hd3_sintel-clean_fgsm_two_%A_%a.out
#SBATCH --error=slurm/hd3_sintel-clean_fgsm_two_err_%A_%a.out
