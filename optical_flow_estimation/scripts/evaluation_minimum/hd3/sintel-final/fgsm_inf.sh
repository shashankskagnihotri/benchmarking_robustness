...
#SBATCH --array=0-3%4
#SBATCH --job-name=hd3_sintel-final_fgsm_inf
#SBATCH --output=slurm/hd3_sintel-final_fgsm_inf_%A_%a.out
#SBATCH --error=slurm/hd3_sintel-final_fgsm_inf_err_%A_%a.out
