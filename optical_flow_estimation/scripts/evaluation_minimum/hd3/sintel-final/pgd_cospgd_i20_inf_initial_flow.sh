...
#SBATCH --array=0-1%2
#SBATCH --job-name=hd3_sintel-final_pgd_cospgd_i20_inf_init
#SBATCH --output=slurm/hd3_sintel-final_pgd_cospgd_i20_inf_init_%A_%a.out
#SBATCH --error=slurm/hd3_sintel-final_pgd_cospgd_i20_inf_init_err_%A_%a.out
