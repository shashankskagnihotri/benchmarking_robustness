...
#SBATCH --job-name=gmflownet_kitti-2015_pcfa
#SBATCH --output=slurm/gmflownet_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/gmflownet_kitti-2015_pcfa_err_%A_%a.out
