...
#SBATCH --array=0-7%4
#SBATCH --job-name=gmflownet_kitti-2015_3dcc
#SBATCH --output=slurm/gmflownet_kitti-2015_3dcc_%A_%a.out
#SBATCH --error=slurm/gmflownet_kitti-2015_3dcc_err_%A_%a.out
