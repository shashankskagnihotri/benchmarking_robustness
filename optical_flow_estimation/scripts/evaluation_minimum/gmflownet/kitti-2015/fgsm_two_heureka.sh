...
#SBATCH --job-name=gmflownet_kitti-2015_fgsm_i20_two
#SBATCH --output=slurm/gmflownet_kitti-2015_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/gmflownet_kitti-2015_fgsm_i20_two_err_%A_%a.out
