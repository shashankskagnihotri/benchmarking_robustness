...
#SBATCH --array=0-6%4
#SBATCH --job-name=gmflownet_sintel-clean_fgsm
#SBATCH --output=slurm/gmflownet_sintel-clean_fgsm_%A_%a.out
#SBATCH --error=slurm/gmflownet_sintel-clean_fgsm_err_%A_%a.out
