...
#SBATCH --array=0-14%4
#SBATCH --job-name=gmflownet_sintel-final_cc
#SBATCH --output=slurm/gmflownet_sintel-final_cc_%A_%a.out
#SBATCH --error=slurm/gmflownet_sintel-final_cc_err_%A_%a.out
