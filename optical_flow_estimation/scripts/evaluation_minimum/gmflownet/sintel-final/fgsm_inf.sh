...
#SBATCH --array=0-3%4
#SBATCH --job-name=gmflownet_sintel-final_fgsm_inf
#SBATCH --output=slurm/gmflownet_sintel-final_fgsm_inf_%A_%a.out
#SBATCH --error=slurm/gmflownet_sintel-final_fgsm_inf_err_%A_%a.out
