...
#SBATCH --array=0-1%2
#SBATCH --job-name=seperableflow_sintel-clean_pcfa_i20
#SBATCH --output=slurm/seperableflow_sintel-clean_pcfa_i20.out
#SBATCH --error=slurm/seperableflow_sintel-clean_pcfa_i20_err_%A_%a.out
