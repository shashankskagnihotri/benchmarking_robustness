...
#SBATCH --array=0-2%2
#SBATCH --job-name=gma_sintel-final_fgsm_two
#SBATCH --output=slurm/gma_sintel-final_fgsm_two_%A_%a.out
#SBATCH --error=slurm/gma_sintel-final_fgsm_two_err_%A_%a.out
