...
#SBATCH --array=0-44%4
#SBATCH --job-name=gma_kitti-2015_bim_pgd_cospgd_i3
#SBATCH --output=slurm/gma_kitti-2015_bim_pgd_cospgd_i3_%A_%a.out
#SBATCH --error=slurm/gma_kitti-2015_bim_pgd_cospgd_i3_err_%A_%a.out
