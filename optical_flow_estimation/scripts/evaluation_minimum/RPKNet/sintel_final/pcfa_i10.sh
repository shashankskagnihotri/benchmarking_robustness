...
#SBATCH --array=0-1%2
#SBATCH --job-name=rpknet_sintel-final_pcfa_i10
#SBATCH --output=slurm/rpknet_sintel-final_pcfa_i10_%A_%a.out
#SBATCH --error=slurm/rpknet_sintel-final_pcfa_i10_err_%A_%a.out
