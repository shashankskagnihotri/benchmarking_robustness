...
#SBATCH --job-name=rapidflow_sintel-final_pcfa
#SBATCH --output=slurm/rapidflow_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/rapidflow_sintel-final_pcfa_err_%A_%a.out
