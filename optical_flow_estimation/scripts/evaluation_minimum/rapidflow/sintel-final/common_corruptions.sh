...
#SBATCH --array=0-74%4
#SBATCH --job-name=rapidflow_sintel-final_cc
#SBATCH --output=slurm/rapidflow_sintel-final_cc_%A_%a.out
#SBATCH --error=slurm/rapidflow_sintel-final_cc_err_%A_%a.out
