...
#SBATCH --job-name=rapidflow_kitti-2015_pcfa
#SBATCH --output=slurm/rapidflow_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/rapidflow_kitti-2015_pcfa_err_%A_%a.out
