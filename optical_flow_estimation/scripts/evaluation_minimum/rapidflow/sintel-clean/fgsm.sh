...
#SBATCH --array=0-6%4
#SBATCH --job-name=rapidflow_sintel-clean_fgsm
#SBATCH --output=slurm/rapidflow_sintel-clean_fgsm_%A_%a.out
#SBATCH --error=slurm/rapidflow_sintel-clean_fgsm_err_%A_%a.out
