...
#SBATCH --array=0-1%2
#SBATCH --job-name=skflow_kitti-2015_pgd_cospgd_i20_inf_init
#SBATCH --output=slurm/skflow_kitti-2015_pgd_cospgd_i20_inf_init_%A_%a.out
#SBATCH --error=slurm/skflow_kitti-2015_pgd_cospgd_i20_inf_init_err_%A_%a.out
