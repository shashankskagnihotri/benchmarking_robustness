...
#SBATCH --job-name=skflow_sintel-final_pcfa
#SBATCH --output=slurm/skflow_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/skflow_sintel-final_pcfa_err_%A_%a.out
