...
#SBATCH --job-name=sintel_final_missing_two
#SBATCH --output=slurm/sintel_final_missing_iterations_two_%A_%a.out
#SBATCH --error=slurm/sintel_final_missing_iterations_two_err_%A_%a.out
#SBATCH --array=0-1%4
