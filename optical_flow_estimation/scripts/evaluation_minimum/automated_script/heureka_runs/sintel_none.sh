...
#SBATCH --job-name=sintel_none
#SBATCH --output=slurm/sintel_none_%A_%a.out
#SBATCH --error=slurm/sintel_none_err_%A_%a.out
#SBATCH --array=0-11%4

models="raft gma pwcnet rpknet dicl fastflownet maskflownet flow1d gmflow gmflownet hd3 irr_pwc liteflownet liteflownet2 liteflownet3 llaflow matchflow rapidflow scopeflow scv4 separableflow skflow starflow videoflow_bof"
datasets="sintel-clean sintel-final"
checkpoint="sintel"
targeteds="False"
targets="negative"
norm="two"
