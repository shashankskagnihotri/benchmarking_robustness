...
#SBATCH --output=slurm/kitti_none_%A_%a.out
#SBATCH --error=slurm/kitti_none_err_%A_%a.out
#SBATCH --array=0-5%4

models="raft gma rpknet csflow dicl fastflownet maskflownet flow1d gmflow gmflownet hd3 irr_pwc liteflownet liteflownet2 liteflownet3_pseudoreg llaflow matchflow rapidflow scopeflow scv4 separableflow skflow starflow videoflow_bof"
dataset="kitti-2015"
checkpoint="kitti"
targeteds="False"
targets="negative"
