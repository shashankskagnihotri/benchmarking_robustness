...
#SBATCH --array=0-23%4
#SBATCH --job-name=rerun_kitti_targeted_inf_4
#SBATCH --output=slurm/rerun_kitti_targeted_inf_4_%A_%a.out
#SBATCH --error=slurm/rerun_kitti_targeted_inf_4_err_%A_%a.out

models="flowformer flowformer++ dip"
dataset="kitti-2015"
checkpoint="kitti"
targeted="True"
