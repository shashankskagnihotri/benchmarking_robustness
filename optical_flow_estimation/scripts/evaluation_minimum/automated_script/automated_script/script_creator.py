...
sintel_model_names = [
    ...
    "starflow",
    "videoflow_bof",
]  # Add your actual model names for both sintel-clean and sintel-final
gpu_a100_models = ["flowformer", "flowformer++", "dip", "ms_raft+"]
    ...
    if folder in kitti_model_names:
        ...
        for file in os.listdir(source_dir):
            ...
            if folder in gpu_a100_models:
                data = data.replace("gpu_4", "gpu_4_a100")
