...
#SBATCH --array=0-47%4
#SBATCH --job-name=crerun_kitti_targeted_inf_3
#SBATCH --output=slurm/rerun_kitti_targeted_inf_3_%A_%a.out
#SBATCH --error=slurm/rerun_kitti_targeted_inf_3_err_%A_%a.out

models="gmflownet hd3 irr_pwc liteflownet maskflownet flow1d"
dataset="kitti-2015"
checkpoint="kitti"
targeted="True"
