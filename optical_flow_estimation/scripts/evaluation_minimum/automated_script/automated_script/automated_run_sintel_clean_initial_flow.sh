...
declare -A scripts_and_amounts=(
  ...
  ["/pfs/work7/workspace/scratch/ma_lucschwa-team_project_fss2024/benchmarking_robustness/optical_flow_estimation/scripts/evaluation_minimum/msraft+/sintel-clean/pgd_cospgd_i20_inf_initial_flow.sh"]=2
