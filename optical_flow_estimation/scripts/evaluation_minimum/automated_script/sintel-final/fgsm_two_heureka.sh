...
#SBATCH --job-name=model_name_sintel-final_fgsm_i20_two
#SBATCH --output=slurm/model_name_sintel-final_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/model_name_sintel-final_fgsm_i20_two_err_%A_%a.out
