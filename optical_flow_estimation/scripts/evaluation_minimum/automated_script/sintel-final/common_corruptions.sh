...
#SBATCH --array=0-14%4
#SBATCH --job-name=model_name_sintel-final_cc
#SBATCH --output=slurm/model_name_sintel-final_cc_%A_%a.out
#SBATCH --error=slurm/model_name_sintel-final_cc_err_%A_%a.out
