...
#SBATCH --array=0-7%4
#SBATCH --job-name=model_name_sintel-final_3dcc
#SBATCH --output=slurm/model_name_sintel-final_3dcc_%A_%a.out
#SBATCH --error=slurm/model_name_sintel-final_3dcc_err_%A_%a.out
