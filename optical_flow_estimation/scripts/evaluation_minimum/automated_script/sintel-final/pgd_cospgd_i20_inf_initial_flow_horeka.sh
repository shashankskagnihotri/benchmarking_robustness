...
#SBATCH --job-name=model_name_sintel-final_bim_pgd_cospgd_i20_inf_init
#SBATCH --output=slurm/model_name_sintel-final_bim_pgd_cospgd_i20_inf_init_%A_%a_.out
#SBATCH --error=slurm/model_name_sintel-final_bim_pgd_cospgd_i20_inf_init_err_%A_%a.out
#SBATCH --array=0-1%2
