...
#SBATCH --job-name=model_name_sintel-final_pcfa
#SBATCH --output=slurm/model_name_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/model_name_sintel-final_pcfa_err_%A_%a.out
