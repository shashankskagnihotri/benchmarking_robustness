...
#SBATCH --array=0-6%4
#SBATCH --job-name=model_name_sintel-final_fgsm
#SBATCH --output=slurm/model_name_sintel-final_fgsm_%A_%a.out
#SBATCH --error=slurm/model_name_sintel-final_fgsm_err_%A_%a.out
