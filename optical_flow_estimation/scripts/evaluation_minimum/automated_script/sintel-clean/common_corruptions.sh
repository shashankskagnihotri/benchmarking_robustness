...
#SBATCH --array=0-74%4
#SBATCH --job-name=model_name_sintel-clean_cc
#SBATCH --output=slurm/model_name_sintel-clean_cc_%A_%a.out
#SBATCH --error=slurm/model_name_sintel-clean_cc_err_%A_%a.out
