...
#SBATCH --job-name=model_name_sintel-clean_pcfa
#SBATCH --output=slurm/model_name_sintel-clean_pcfa_%A_%a.out
#SBATCH --error=slurm/model_name_sintel-clean_pcfa_err_%A_%a.out
