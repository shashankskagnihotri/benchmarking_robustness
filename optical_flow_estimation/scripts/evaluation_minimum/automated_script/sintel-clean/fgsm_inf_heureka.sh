...
#SBATCH --job-name=model_name_sintel-clean_fgsm_i20_inf
#SBATCH --output=slurm/model_name_sintel-clean_fgsm_i20_inf_%A_%a.out
#SBATCH --error=slurm/model_name_sintel-clean_fgsm_i20_inf_err_%A_%a.out
