...
#SBATCH --array=0-20%4
#SBATCH --job-name=model_name_sintel-clean_bim_pgd_cospgd_i20
#SBATCH --output=slurm/model_name_sintel-clean_bim_pgd_cospgd_i20_%A_%a.out
#SBATCH --error=slurm/model_name_sintel-clean_bim_pgd_cospgd_i20_err_%A_%a.out
