...
#SBATCH --array=0-1%2
#SBATCH --job-name=model_name_kitti-2015_pcfa_i20
#SBATCH --output=slurm/model_name_kitti-2015_pcfa_i20.out
#SBATCH --error=slurm/model_name_kitti-2015_pcfa_i20_err_%A_%a.out
