...
#SBATCH --job-name=model_name_kitti-2015_pcfa
#SBATCH --output=slurm/model_name_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/model_name_kitti-2015_pcfa_err_%A_%a.out
