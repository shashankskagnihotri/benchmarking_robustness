...
#SBATCH --array=0-74%4
#SBATCH --job-name=model_name_kitti-2015_cc
#SBATCH --output=slurm/model_name_kitti-2015_cc_%A_%a.out
#SBATCH --error=slurm/model_name_kitti-2015_cc_err_%A_%a.out
