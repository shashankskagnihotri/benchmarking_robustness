...
#SBATCH --job-name=raft_kitti-2015_pcfa_i20_255
#SBATCH --output=slurm/raft_kitti-2015_pcfa_i20_255_%A.out
#SBATCH --error=slurm/raft_kitti-2015_pcfa_i20_err_255_%A.out
