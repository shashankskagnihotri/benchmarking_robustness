...
#SBATCH --array=0-1%2
#SBATCH --job-name=raft_sintel-final_pcfa_i20
#SBATCH --output=slurm/raft_sintel-final_pcfa_i20_%A_%a.out
#SBATCH --error=slurm/raft_sintel-final_pcfa_i20_err_%A_%a.out
