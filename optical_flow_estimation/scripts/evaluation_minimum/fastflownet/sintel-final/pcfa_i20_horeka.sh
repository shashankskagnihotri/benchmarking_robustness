...
#SBATCH --job-name=fastflownet_sintel-final_pcfa
#SBATCH --output=slurm/fastflownet_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/fastflownet_sintel-final_pcfa_err_%A_%a.out
