...
#SBATCH --array=0-14%4
#SBATCH --job-name=fastflownet_sintel-clean_fgsm
#SBATCH --output=slurm/fastflownet_sintel-clean_fgsm_%A_%a.out
#SBATCH --error=slurm/fastflownet_sintel-clean_fgsm_err_%A_%a.out
