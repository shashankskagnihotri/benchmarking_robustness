...
#SBATCH --job-name=fastflownet_kitti-2015_pcfa
#SBATCH --output=slurm/fastflownet_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/fastflownet_kitti-2015_pcfa_err_%A_%a.out
