...
#SBATCH --array=0-8%4
#SBATCH --job-name=fastflownet_kitti-2015_bim_pgd_cospgd_i20_two
#SBATCH --output=slurm/fastflownet_kitti-2015_bim_pgd_cospgd_i20_two_%A_%a.out
#SBATCH --error=slurm/fastflownet_kitti-2015_bim_pgd_cospgd_i20_two_err_%A_%a.out
