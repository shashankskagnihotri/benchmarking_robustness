...
#SBATCH --job-name=fastflownet_sintel-clean_fgsm_i20_inf
#SBATCH --output=slurm/fastflownet_sintel-clean_fgsm_i20_inf_%A_%a.out
#SBATCH --error=slurm/fastflownet_sintel-clean_fgsm_i20_inf_err_%A_%a.out
