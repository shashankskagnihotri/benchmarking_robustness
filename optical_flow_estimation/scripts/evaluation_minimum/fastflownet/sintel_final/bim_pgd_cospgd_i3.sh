...
#SBATCH --array=0-35%4
#SBATCH --job-name=fastflownet_sintel-final_bim_pgd_cospgd_i3
#SBATCH --output=slurm/fastflownet_sintel-final_bim_pgd_cospgd_i3_%A_%a.out
#SBATCH --error=slurm/fastflownet_sintel-final_bim_pgd_cospgd_i3_err_%A_%a.out
