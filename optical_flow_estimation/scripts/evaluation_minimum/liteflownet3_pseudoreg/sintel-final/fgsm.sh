...
#SBATCH --array=0-6%4
#SBATCH --job-name=liteflownet3_pseudoreg_sintel-final_fgsm
#SBATCH --output=slurm/liteflownet3_pseudoreg_sintel-final_fgsm_%A_%a.out
#SBATCH --error=slurm/liteflownet3_pseudoreg_sintel-final_fgsm_err_%A_%a.out
