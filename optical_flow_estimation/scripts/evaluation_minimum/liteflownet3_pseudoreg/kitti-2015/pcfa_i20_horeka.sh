...
#SBATCH --job-name=liteflownet3_pseudoreg_kitti-2015_pcfa
#SBATCH --output=slurm/liteflownet3_pseudoreg_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/liteflownet3_pseudoreg_kitti-2015_pcfa_err_%A_%a.out
