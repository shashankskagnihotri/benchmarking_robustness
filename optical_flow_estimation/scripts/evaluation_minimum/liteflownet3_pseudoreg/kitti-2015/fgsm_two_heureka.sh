...
#SBATCH --job-name=liteflownet3_pseudoreg_kitti-2015_fgsm_i20_two
#SBATCH --output=slurm/liteflownet3_pseudoreg_kitti-2015_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/liteflownet3_pseudoreg_kitti-2015_fgsm_i20_two_err_%A_%a.out
