...
#SBATCH --array=0-2%4
#SBATCH --job-name=llaflow_sintel-clean_fgsm_two
#SBATCH --output=slurm/llaflow_sintel-clean_fgsm_two_%A_%a.out
#SBATCH --error=slurm/llaflow_sintel-clean_fgsm_two_err_%A_%a.out
