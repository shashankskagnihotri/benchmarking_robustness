...
#SBATCH --array=0-7%4
#SBATCH --job-name=llaflow_sintel-final_3dcc
#SBATCH --output=slurm/llaflow_sintel-final_3dcc_%A_%a.out
#SBATCH --error=slurm/llaflow_sintel-final_3dcc_err_%A_%a.out
