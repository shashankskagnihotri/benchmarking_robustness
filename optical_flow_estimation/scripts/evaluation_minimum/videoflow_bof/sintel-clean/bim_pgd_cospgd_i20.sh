...
#SBATCH --array=0-20%4
#SBATCH --job-name=videoflow_bof_sintel-clean_bim_pgd_cospgd_i20
#SBATCH --output=slurm/videoflow_bof_sintel-clean_bim_pgd_cospgd_i20_%A_%a.out
#SBATCH --error=slurm/videoflow_bof_sintel-clean_bim_pgd_cospgd_i20_err_%A_%a.out
