...
#SBATCH --job-name=videoflow_bof_sintel-clean_bim_pgd_cospgd_i20_inf
#SBATCH --output=slurm/videoflow_bof_sintel-clean_bim_pgd_cospgd_i20_inf_%A_%a.out
#SBATCH --error=slurm/videoflow_bof_sintel-clean_bim_pgd_cospgd_i20_inf_err_%A_%a.out
#SBATCH --array=0-2%3
