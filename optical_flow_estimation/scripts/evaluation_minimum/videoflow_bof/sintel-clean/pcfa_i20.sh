...
>>>>>>> flow_luca
#SBATCH --array=0-1%2
#SBATCH --job-name=videoflow_bof_sintel-clean_pcfa_i20
#SBATCH --output=slurm/videoflow_bof_sintel-clean_pcfa_i20.out
#SBATCH --error=slurm/videoflow_bof_sintel-clean_pcfa_i20_err_%A_%a.out
