...
#SBATCH --array=0-7%4
#SBATCH --job-name=videoflow_bof_sintel-clean_3dcc
#SBATCH --output=slurm/videoflow_bof_sintel-clean_3dcc_%A_%a.out
#SBATCH --error=slurm/videoflow_bof_sintel-clean_3dcc_err_%A_%a.out
