...
#SBATCH --array=0-74%4
#SBATCH --job-name=videoflow_bof_sintel-clean_cc
#SBATCH --output=slurm/videoflow_bof_sintel-clean_cc_%A_%a.out
#SBATCH --error=slurm/videoflow_bof_sintel-clean_cc_err_%A_%a.out
