...
#SBATCH --job-name=videoflow_bof_kitti-2015_fgsm_i20_inf
#SBATCH --output=slurm/videoflow_bof_kitti-2015_fgsm_i20_inf_%A_%a.out
#SBATCH --error=slurm/videoflow_bof_kitti-2015_fgsm_i20_inf_err_%A_%a.out
