...
#SBATCH --job-name=videoflow_bof_kitti-2015_pcfa
#SBATCH --output=slurm/videoflow_bof_kitti-2015_pcfa_%A_%a.out
#SBATCH --error=slurm/videoflow_bof_kitti-2015_pcfa_err_%A_%a.out
