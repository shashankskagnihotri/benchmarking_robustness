...
#SBATCH --array=0-1%2
#SBATCH --job-name=videoflow_bof_kitti-2015_pcfa_i20
#SBATCH --output=slurm/videoflow_bof_kitti-2015_pcfa_i20.out
#SBATCH --error=slurm/videoflow_bof_kitti-2015_pcfa_i20_err_%A_%a.out
