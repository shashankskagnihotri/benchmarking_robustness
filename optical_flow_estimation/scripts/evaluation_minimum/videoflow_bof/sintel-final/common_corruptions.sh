...
#SBATCH --array=0-14%4
#SBATCH --job-name=videoflow_bof_sintel-final_cc
#SBATCH --output=slurm/videoflow_bof_sintel-final_cc_%A_%a.out
#SBATCH --error=slurm/videoflow_bof_sintel-final_cc_err_%A_%a.out
