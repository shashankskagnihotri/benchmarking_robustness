...
#SBATCH --job-name=videoflow_bof_sintel-final_pcfa
#SBATCH --output=slurm/videoflow_bof_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/videoflow_bof_sintel-final_pcfa_err_%A_%a.out
