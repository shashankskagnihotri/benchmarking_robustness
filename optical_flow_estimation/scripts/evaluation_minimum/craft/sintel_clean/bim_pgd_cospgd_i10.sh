...
#SBATCH --array=0-44%4
#SBATCH --job-name=craft_sintel-clean_bim_pgd_cospgd_i10
#SBATCH --output=slurm/craft_sintel-clean_bim_pgd_cospgd_i10_%A_%a.out
#SBATCH --error=slurm/craft_sintel-clean_bim_pgd_cospgd_i10_err_%A_%a.out
