...
#SBATCH --job-name=craft_kitti-2015_fgsm_i20_inf
#SBATCH --output=slurm/craft_kitti-2015_fgsm_i20_inf_%A_%a.out
#SBATCH --error=slurm/craft_kitti-2015_fgsm_i20_inf_err_%A_%a.out
