...
#SBATCH --job-name=scv4_sintel-final_fgsm_i20_two
#SBATCH --output=slurm/scv4_sintel-final_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/scv4_sintel-final_fgsm_i20_two_err_%A_%a.out
