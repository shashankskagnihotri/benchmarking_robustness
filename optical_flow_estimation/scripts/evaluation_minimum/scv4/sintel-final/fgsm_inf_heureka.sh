...
#SBATCH --job-name=scv4_sintel-final_fgsm_i20_inf
#SBATCH --output=slurm/scv4_sintel-final_fgsm_i20_inf_%A_%a.out
#SBATCH --error=slurm/scv4_sintel-final_fgsm_i20_inf_err_%A_%a.out
