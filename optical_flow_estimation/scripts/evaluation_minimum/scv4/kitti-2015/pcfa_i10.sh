...
#SBATCH --array=0-1%2
#SBATCH --job-name=scv4_kitti-2015_pcfa_i10
#SBATCH --output=slurm/scv4_kitti-2015_pcfa_i10_%A_%a.out
#SBATCH --error=slurm/scv4_kitti-2015_pcfa_i10_err_%A_%a.out
