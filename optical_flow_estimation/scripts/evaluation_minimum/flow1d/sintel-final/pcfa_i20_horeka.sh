...
#SBATCH --job-name=flow1d_sintel-final_pcfa
#SBATCH --output=slurm/flow1d_sintel-final_pcfa_%A_%a.out
#SBATCH --error=slurm/flow1d_sintel-final_pcfa_err_%A_%a.out
