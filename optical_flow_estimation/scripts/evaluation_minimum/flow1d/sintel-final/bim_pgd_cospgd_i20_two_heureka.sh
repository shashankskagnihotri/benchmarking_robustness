...
#SBATCH --job-name=flow1d_sintel-final_bim_pgd_cospgd_i20_two
#SBATCH --output=slurm/flow1d_sintel-final_bim_pgd_cospgd_i20_two_%A_%a.out
#SBATCH --error=slurm/flow1d_sintel-final_bim_pgd_cospgd_i20_two_err_%A_%a.out
#SBATCH --array=0-1%4
