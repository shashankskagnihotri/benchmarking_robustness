...
#SBATCH --job-name=flow1d_kitti-2015_fgsm_i20_two
#SBATCH --output=slurm/flow1d_kitti-2015_fgsm_i20_two_%A_%a.out
#SBATCH --error=slurm/flow1d_kitti-2015_fgsm_i20_two_err_%A_%a.out
