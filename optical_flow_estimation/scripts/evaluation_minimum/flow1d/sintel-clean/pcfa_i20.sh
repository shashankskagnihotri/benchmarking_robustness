...
#SBATCH --array=0-1%2
#SBATCH --job-name=flow1d_sintel-clean_pcfa_i20
#SBATCH --output=slurm/flow1d_sintel-clean_pcfa_i20.out
#SBATCH --error=slurm/flow1d_sintel-clean_pcfa_i20_err_%A_%a.out
