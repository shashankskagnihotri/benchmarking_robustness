...
#SBATCH --array=0-6%4
#SBATCH --job-name=flow1d_sintel-clean_fgsm
#SBATCH --output=slurm/flow1d_sintel-clean_fgsm_%A_%a.out
#SBATCH --error=slurm/flow1d_sintel-clean_fgsm_err_%A_%a.out
