...
#SBATCH --array=0-1%2
#SBATCH --job-name=csflow_kitti-2015_pcfa_i10
#SBATCH --output=slurm/csflow_kitti-2015_pcfa_i10_%A_%a.out
#SBATCH --error=slurm/csflow_kitti-2015_pcfa_i10_err_%A_%a.out
