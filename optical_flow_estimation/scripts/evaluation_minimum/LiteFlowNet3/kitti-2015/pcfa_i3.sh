...
#SBATCH --array=0-1%2
#SBATCH --job-name=liteflownet3_kitti-2015_pcfa_i3
#SBATCH --output=slurm/liteflownet3_kitti-2015_pcfa_i3_%A_%a.out
#SBATCH --error=slurm/liteflownet3_kitti-2015_pcfa_i3_err_%A_%a.out
