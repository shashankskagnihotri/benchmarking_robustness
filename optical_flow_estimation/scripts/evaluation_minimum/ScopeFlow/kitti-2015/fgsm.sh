...
#SBATCH --array=0-14%4
#SBATCH --job-name=scopeflow_kitti-2015_fgsm
#SBATCH --output=slurm/scopeflow_kitti-2015_fgsm_%A_%a.out
#SBATCH --error=slurm/scopeflow_kitti-2015_fgsm_err_%A_%a.out
