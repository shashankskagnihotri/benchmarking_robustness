...
#SBATCH --array=0-44%4
#SBATCH --job-name=flowformer++_sintel-clean_bim_pgd_cospgd_i10
#SBATCH --output=slurm/flowformer++_sintel-clean_bim_pgd_cospgd_i10_%A_%a.out
#SBATCH --error=slurm/flowformer++_sintel-clean_bim_pgd_cospgd_i10_err_%A_%a.out
