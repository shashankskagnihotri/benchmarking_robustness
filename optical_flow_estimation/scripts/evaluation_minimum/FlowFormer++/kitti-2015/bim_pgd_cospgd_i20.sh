...
#SBATCH --array=0-44%4
#SBATCH --job-name=flowformer++_kitti-2015_bim_pgd_cospgd_i20
#SBATCH --output=slurm/flowformer++_kitti-2015_bim_pgd_cospgd_i20_%A_%a.out
#SBATCH --error=slurm/flowformer++_kitti-2015_bim_pgd_cospgd_i20_err_%A_%a.out
