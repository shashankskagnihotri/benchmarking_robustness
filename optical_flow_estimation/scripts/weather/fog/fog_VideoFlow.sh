...
#SBATCH --job-name=fog_videoflow_bof
#SBATCH --output=slurm/fog/videoflow_bof/fog_videoflow_bof_%j.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/fog/videoflow_bof/fog_videoflow_bof_%j.err
