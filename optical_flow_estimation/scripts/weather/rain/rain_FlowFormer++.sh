...
#SBATCH --job-name=rain_flowformer++
#SBATCH --output=slurm/rain/flowformer++/rain_flowformer++_%j.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_8
#SBATCH --error=slurm/rain/flowformer++/rain_flowformer++_%j.err
