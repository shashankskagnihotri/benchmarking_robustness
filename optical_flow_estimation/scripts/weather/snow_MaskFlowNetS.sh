...
#SBATCH --job-name=snow_maskflownet_s
#SBATCH --output=slurm/snow/maskflownet_s/snow_maskflownet_s_%j.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4_a100
#SBATCH --error=slurm/snow/maskflownet_s/snow_maskflownet_s_%j.err
