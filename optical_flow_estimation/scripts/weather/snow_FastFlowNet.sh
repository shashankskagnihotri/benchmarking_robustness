...
#SBATCH --job-name=snow_fastflownet
#SBATCH --output=slurm/snow/fastflownet/snow_fastflownet_%j.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4_a100
#SBATCH --error=slurm/snow/fastflownet/snow_fastflownet_%j.err
