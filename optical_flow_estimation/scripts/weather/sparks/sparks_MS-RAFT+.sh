...
#SBATCH --job-name=sparks_ms_raft+
#SBATCH --output=slurm/sparks/ms_raft+/sparks_ms_raft+_%j.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_8
#SBATCH --error=slurm/sparks/ms_raft+/sparks_ms_raft+_%j.err
