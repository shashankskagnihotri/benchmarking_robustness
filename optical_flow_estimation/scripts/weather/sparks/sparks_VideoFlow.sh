...
#SBATCH --job-name=sparks_videoflow_bof
#SBATCH --output=slurm/sparks/videoflow_bof/sparks_videoflow_bof_%j.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_8
#SBATCH --error=slurm/sparks/videoflow_bof/sparks_videoflow_bof_%j.err
