...
#SBATCH --job-name=sparks_maskflownet
#SBATCH --output=slurm/sparks/maskflownet/sparks_maskflownet_%j.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/sparks/maskflownet/sparks_maskflownet_%j.err
