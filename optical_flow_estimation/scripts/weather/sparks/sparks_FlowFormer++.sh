...
#SBATCH --job-name=sparks_flowformer++
#SBATCH --output=slurm/sparks/flowformer++/sparks_flowformer++_%j.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_8
#SBATCH --error=slurm/sparks/flowformer++/sparks_flowformer++_%j.err
