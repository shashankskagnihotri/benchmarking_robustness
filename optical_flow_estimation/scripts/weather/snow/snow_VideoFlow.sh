...
#SBATCH --job-name=snow_videoflow_bof
#SBATCH --output=slurm/snow/videoflow_bof/snow_videoflow_bof_%j.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/snow/videoflow_bof/snow_videoflow_bof_%j.err
