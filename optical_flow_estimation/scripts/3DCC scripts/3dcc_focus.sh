...
#SBATCH --job-name=3DCCfocus
#SBATCH --output=slurm/3DCCfocus.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/3DCCfocus.out

rgb_path=/pfs/work7/workspace/scratch/ma_jcaspary-team_project_fss2024/datasets/kitti2015/training/image_2
depth_path=/pfs/work7/workspace/scratch/ma_jcaspary-team_project_fss2024/datasets_depth/kitti2015/training/image_2
output_path=/pfs/work7/workspace/scratch/ma_jcaspary-team_project_fss2024/datasets_corrupted/kitti2015/training/image_2
