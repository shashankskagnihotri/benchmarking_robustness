...
#SBATCH --job-name=sintel_training_clean_3DCCfog
#SBATCH --output=slurm/sintel_training_clean_3DCCfog.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/sintel_training_clean_3DCCfog.out
