...
#SBATCH --job-name=sintel_test_clean_3DCClowlight
#SBATCH --output=slurm/sintel_test_clean_3DCClowloght.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/sintel_test_clean_3DCClowlight.out
