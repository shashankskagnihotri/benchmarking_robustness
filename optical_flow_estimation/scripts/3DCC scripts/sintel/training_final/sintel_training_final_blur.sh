...
#SBATCH --job-name=sintel_training_final_3DCCblur
#SBATCH --output=slurm/sintel_training_final_3DCCblur.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/sintel_training_final_3DCCblur.out
