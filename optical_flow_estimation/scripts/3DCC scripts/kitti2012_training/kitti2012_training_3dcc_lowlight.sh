...
#SBATCH --job-name=kitti2012_training_3DCClowlight
#SBATCH --output=slurm/kitti2012_training_3DCClowlight.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/kitti2012_training_3DCClowlight.out
