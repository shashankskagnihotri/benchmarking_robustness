...
#SBATCH --job-name=kitti2012_training_3DCCfog
#SBATCH --output=slurm/kitti_2012_training_3DCCfog.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/kitti2012_training_3DCCfog.out
...
python create_3dcc_fog.py --path_rgb $rgb_path --path_depth $depth_path --path_target $output_path --batch_size 1
