...
#SBATCH --job-name=kitti2012_training_3DCCfocus
#SBATCH --output=slurm/kitti2012_training_3DCCfocus.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/kitti2012_training_3DCCfocus.out

rgb_path=/pfs/work7/workspace/scratch/ma_jcaspary-team_project_fss2024/datasets/kitti2012/training/colored_0
depth_path=/pfs/work7/workspace/scratch/ma_jcaspary-team_project_fss2024/datasets_depth/kitti2012/training/colored_0
output_path=/pfs/work7/workspace/scratch/ma_jcaspary-team_project_fss2024/datasets_corrupted/kitti2012/training/colored_0
...
python create_3dcc_focus.py --path_rgb $rgb_path --path_depth $depth_path --path_target $output_path --batch_size 1
