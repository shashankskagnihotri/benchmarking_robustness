...
#SBATCH --job-name=Sintel4
#SBATCH --output=slurm/Sintel4.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/Sintel4.out

# The parent directory you want to scan
PARENT_DIR="/pfs/work7/workspace/scratch/ma_jcaspary-team_project_fss2024/datasets/Sintel/training/clean/"
OUTPUT_DIR="/pfs/work7/workspace/scratch/ma_jcaspary-team_project_fss2024/datasets_depth/Sintel/training/clean/"
