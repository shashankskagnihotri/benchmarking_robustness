...
#SBATCH --job-name=Sintel3
#SBATCH --output=slurm/Sintel3.out
#SBATCH --cpus-per-task=16
#SBATCH --gres=gpu:1
#SBATCH --partition=gpu_4
#SBATCH --error=slurm/Sintel3.out

# The parent directory you want to scan
PARENT_DIR="/pfs/work7/workspace/scratch/ma_jcaspary-team_project_fss2024/datasets/Sintel/training/final/"
OUTPUT_DIR="/pfs/work7/workspace/scratch/ma_jcaspary-team_project_fss2024/datasets_depth/Sintel/training/final/"
