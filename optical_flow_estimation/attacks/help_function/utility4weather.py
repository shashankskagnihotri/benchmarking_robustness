...
def prepare_dataloader(args, shuffle=False, batch_size=1, get_weather=False):
    ...
    """
    if args["weather_dataset"] == 'Sintel':
        if args["weather_dataset_stage"] == 'training':
        ...
        elif args["weather_dataset_stage"] == 'evaluation':
        ...
        raise ValueError("Unknown dataset %s, use 'Sintel' dataset." )
