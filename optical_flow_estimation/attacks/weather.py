...
def weather_ds(
    ...
    print("The device that is running now is:", device)

    batch_size = 1
    # save image
    experiment_id, folder_path, folder_name = logging.mlflow_experimental_setup(attack_args["weather_output_folder"], "gma", "weather", False, False)
    print("outputfolder is: ", folder_path)
    ...
    #         preds = attack_image(model, targeted_inputs, attack_args, device, scene_data, weather, batch_size, distortion_folder)
