from ..mmflow.mmflow.datasets.base_dataset import BaseDataset
from ..mmflow.mmflow.datasets.builder import DATASETS
from ..mmflow.mmflow.datasets.base_dataset import BaseDataset
from ..mmflow.mmflow.datasets.builder import DATASETS
...
class SPRING(BaseDataset):
    ...
    def pre_pipeline(self, results: dict):
        # Implement dataset-specific processing steps
        pass