...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../acdc_workdir/cityscapes/acdc_rain/mask2former/mask2former_swin-t_8xb2-90k_acdc-512x1024/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../acdc_workdir/cityscapes/acdc_rain/mask2former/mask2former_swin-t_8xb2-90k_acdc-512x1024'
