...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../acdc_workdir/cityscapes/unet/unet-s5-d16_fcn_4xb4-160k_cityscapes-512x1024/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../acdc_workdir/cityscapes/unet/unet-s5-d16_fcn_4xb4-160k_cityscapes-512x1024'
