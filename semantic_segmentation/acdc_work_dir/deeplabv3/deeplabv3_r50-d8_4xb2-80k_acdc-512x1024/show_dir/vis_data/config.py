...
launcher = 'none'
load_from = '../checkpoint_files/deeplabv3/deeplabv3_r50-d8_512x1024_80k_acdc.pth'
log_level = 'INFO'
...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../acdc_work_dir/deeplabv3/deeplabv3_r50-d8_4xb2-80k_acdc-512x1024/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../acdc_work_dir/deeplabv3/deeplabv3_r50-d8_4xb2-80k_acdc-512x1024'
