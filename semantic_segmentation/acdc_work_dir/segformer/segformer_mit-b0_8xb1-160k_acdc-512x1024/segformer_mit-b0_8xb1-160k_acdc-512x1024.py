...
launcher = 'none'
load_from = '../checkpoint_files/segformer/segformer_mit-b0_8xb1-160k_cityscapes-512x1024.pth'
log_level = 'INFO'
...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../acdc_work_dir/segformer/segformer_mit-b0_8xb1-160k_acdc-512x1024/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../acdc_work_dir/segformer/segformer_mit-b0_8xb1-160k_acdc-512x1024'
