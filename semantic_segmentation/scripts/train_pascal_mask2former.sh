...
#SBATCH --output=slurm/train_pascal_mask2former_%a.out
#SBATCH --array=1-3
...
then
    python tools/train.py ../configs/mask2former/mask2former_swin-b-in1k-384x384-pre_8xb2-160k_voc12aug-512x512.py --work-dir ../work_dirs/mask2former_swin-b-in1k-384x384-pre_8xb2-160k_voc12aug-512x512
else
    echo "All submitted"
fi
