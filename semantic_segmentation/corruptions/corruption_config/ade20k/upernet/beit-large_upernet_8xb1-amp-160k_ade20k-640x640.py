_base_ = [
    '../../../../mmsegmentation/configs/_base_/models/upernet_beit.py', '../../../../mmsegmentation/configs/_base_/datasets/ade20k_640x640.py',
    '../../../../mmsegmentation/configs/_base_/default_runtime.py', '../../../../mmsegmentation/configs/_base_/schedules/schedule_320k.py'
]
crop_size = (640, 640)
model = dict(
