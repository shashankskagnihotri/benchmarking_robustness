...
#SBATCH --job-name=corruption_
#SBATCH --output=slurm/corruption_.out
...
for corruption in "${corruptions[@]}"; do
    ...
    python tools/test.py ../corruptions/corruption_config/pascalvoc/internimage/ \
        ../checkpoint_files/pascalvoc/internimage/ \
        --cfg-options "model.data_preprocessor.corruption=$corruption" \
        --work-dir ../corruptions/work_dirs/pascalvoc/internimage//$corruption
