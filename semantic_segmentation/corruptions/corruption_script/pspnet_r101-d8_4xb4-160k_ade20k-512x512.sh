...
for corruption in "${corruptions[@]}"; do
    ...
    python tools/test.py ../corruptions/corruption_config/ade20k/pspnet/pspnet_r101-d8_4xb4-160k_ade20k-512x512.py \
        ../checkpoint_files/ade20k/pspnet/pspnet_r101-d8_512x512_160k_ade20k_20200615_100650-967c316f.pth \
        --cfg-options "model.data_preprocessor.corruption=$corruption" \
        --work-dir ../corruptions/work_dirs/ade20k/pspnet/pspnet_r101-d8_4xb4-160k_ade20k-512x512/$corruption
