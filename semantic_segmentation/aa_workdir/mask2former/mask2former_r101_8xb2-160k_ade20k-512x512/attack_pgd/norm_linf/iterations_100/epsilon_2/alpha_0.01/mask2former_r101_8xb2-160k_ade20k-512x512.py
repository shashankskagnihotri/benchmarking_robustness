...
model = dict(
    attack_cfg=dict(
        alpha=0.01, epsilon=2, iterations=100, name='pgd', norm='linf'),
    attack_loss=dict(
        loss_weight=1.0,
        reduction='none',
...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../aa_workdir/mask2former/mask2former_r101_8xb2-160k_ade20k-512x512/attack_pgd/norm_linf/iterations_100/epsilon_2/alpha_0.01/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../aa_workdir/mask2former/mask2former_r101_8xb2-160k_ade20k-512x512/attack_pgd/norm_linf/iterations_100/epsilon_2/alpha_0.01'
