...
launcher = 'none'
load_from = '../checkpoint_files/mask2former/mask2former_swin-s_8xb2-160k_ade20k-512x512_20221204_143905-e715144e.pth'
log_level = 'INFO'
...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../aa_workdir/mask2former/mask2former_swin-s_8xb2-160k_ade20k-512x512/attack_cospgd/norm_linf/iterations_20/epsilon_8/alpha_0.01/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../aa_workdir/mask2former/mask2former_swin-s_8xb2-160k_ade20k-512x512/attack_cospgd/norm_linf/iterations_20/epsilon_8/alpha_0.01'
