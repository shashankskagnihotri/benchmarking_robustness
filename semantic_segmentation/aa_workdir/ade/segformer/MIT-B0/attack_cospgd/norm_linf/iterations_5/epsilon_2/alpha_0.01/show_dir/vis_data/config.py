...
test_evaluator = dict(
    ...
    keep_results=True,
    output_dir=
    '../aa_workdir/ade/MIT-B0/attack_cospgd/norm_linf/iterations_5/epsilon_2/alpha_0.01/output',
    type='IoUMetric')
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(keep_ratio=True, scale=(
...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../aa_workdir/ade/MIT-B0/attack_cospgd/norm_linf/iterations_5/epsilon_2/alpha_0.01/show_dir',
