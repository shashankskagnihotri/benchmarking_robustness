...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../aa_workdir/ade/MIT-B3/attack_cospgd/norm_l2/iterations_20/epsilon_64/alpha_0.1/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../aa_workdir/ade/MIT-B3/attack_cospgd/norm_l2/iterations_20/epsilon_64/alpha_0.1'
