...
model = dict(
    attack_cfg=dict(
        alpha=0.01, epsilon=64, iterations=20, name='segpgd', norm='l2'),
    attack_loss=dict(
        loss_weight=1.0,
        reduction='none',
...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../aa_workdir/ade/MIT-B3/attack_segpgd/norm_l2/iterations_20/epsilon_64/alpha_0.01/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../aa_workdir/ade/MIT-B3/attack_segpgd/norm_l2/iterations_20/epsilon_64/alpha_0.01'
