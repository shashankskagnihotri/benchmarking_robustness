...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../aa_workdir/cityscapes/unet/unet-s5-d16_fcn_4xb4-160k_cityscapes-512x1024/attack_segpgd/norm_linf/iterations_20/epsilon_8/alpha_0.01/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../aa_workdir/cityscapes/unet/unet-s5-d16_fcn_4xb4-160k_cityscapes-512x1024/attack_segpgd/norm_linf/iterations_20/epsilon_8/alpha_0.01'
