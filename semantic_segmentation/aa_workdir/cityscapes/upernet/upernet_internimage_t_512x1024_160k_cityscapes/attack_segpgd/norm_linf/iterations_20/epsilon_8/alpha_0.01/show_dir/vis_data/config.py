...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../aa_workdir/cityscapes/upernet/upernet_internimage_t_512x1024_160k_cityscapes/attack_segpgd/norm_linf/iterations_20/epsilon_8/alpha_0.01/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../aa_workdir/cityscapes/upernet/upernet_internimage_t_512x1024_160k_cityscapes/attack_segpgd/norm_linf/iterations_20/epsilon_8/alpha_0.01'
