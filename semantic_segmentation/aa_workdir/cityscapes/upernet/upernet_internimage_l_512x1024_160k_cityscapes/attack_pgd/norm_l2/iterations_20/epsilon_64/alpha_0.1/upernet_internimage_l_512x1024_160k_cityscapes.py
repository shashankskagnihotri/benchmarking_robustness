...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../aa_workdir/cityscapes/upernet/upernet_internimage_l_512x1024_160k_cityscapes/attack_pgd/norm_l2/iterations_20/epsilon_64/alpha_0.1/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../aa_workdir/cityscapes/upernet/upernet_internimage_l_512x1024_160k_cityscapes/attack_pgd/norm_l2/iterations_20/epsilon_64/alpha_0.1'
