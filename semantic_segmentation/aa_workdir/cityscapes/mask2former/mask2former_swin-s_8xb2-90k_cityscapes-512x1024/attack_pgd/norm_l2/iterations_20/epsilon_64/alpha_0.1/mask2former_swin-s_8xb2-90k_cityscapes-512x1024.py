...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../aa_workdir/cityscapes/mask2former/mask2former_swin-s_8xb2-90k_cityscapes-512x1024/attack_pgd/norm_l2/iterations_20/epsilon_64/alpha_0.1/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../aa_workdir/cityscapes/mask2former/mask2former_swin-s_8xb2-90k_cityscapes-512x1024/attack_pgd/norm_l2/iterations_20/epsilon_64/alpha_0.1'
