...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../clean_workdir/ade20k/mask2former/mask2former_swin-s_8xb2-160k_ade20k-512x512/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../clean_workdir/ade20k/mask2former/mask2former_swin-s_8xb2-160k_ade20k-512x512'
