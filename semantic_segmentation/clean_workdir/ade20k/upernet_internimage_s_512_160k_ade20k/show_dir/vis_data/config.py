...
launcher = 'none'
load_from = '../checkpoint_files/upernet_internimage_s_512_160k_ade20k.pth'
log_level = 'INFO'
...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../clean_workdir/ade20k/upernet_internimage_s_512_160k_ade20k/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../clean_workdir/ade20k/upernet_internimage_s_512_160k_ade20k'
