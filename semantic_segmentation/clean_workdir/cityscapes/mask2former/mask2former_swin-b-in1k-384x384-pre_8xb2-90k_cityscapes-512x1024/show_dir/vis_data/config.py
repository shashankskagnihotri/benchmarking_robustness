...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../clean_workdir/cityscapes/mask2former/mask2former_swin-b-in1k-384x384-pre_8xb2-90k_cityscapes-512x1024/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../clean_workdir/cityscapes/mask2former/mask2former_swin-b-in1k-384x384-pre_8xb2-90k_cityscapes-512x1024'
