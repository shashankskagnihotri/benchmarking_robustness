...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../clean_workdir/pascal/upernet/upernet_internimage_t_160k_voc12aug_512x512/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../clean_workdir/pascal/upernet/upernet_internimage_t_160k_voc12aug_512x512'
