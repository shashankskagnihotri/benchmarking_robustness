...
visualizer = dict(
    name='visualizer',
    save_dir=
    '../clean_workdir/pascal/mask2former/mask2former_swin-t_8xb2-160k_voc12aug-512x512/show_dir',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = '../clean_workdir/pascal/mask2former/mask2former_swin-t_8xb2-160k_voc12aug-512x512'
