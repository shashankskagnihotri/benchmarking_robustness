...
cls_layer = dict(
    ...
    use_bias=0.0,
    zs_weight_dim=512,
    zs_weight_path="data/lvis_metadata/lvis_v1_clip_a+cname.npy",
)
custom_imports = dict(
...
model = dict(
    ...
    roi_head=dict(
        ...
        bbox_roi_extractor=dict(
            ...
            out_channels=256,
            roi_layer=dict(
                output_size=7, sampling_ratio=0, type="RoIAlign", use_torchvision=True
            ),
...
train_cfg = dict(max_iters=180000, type="IterBasedTrainLoop", val_interval=180000)
