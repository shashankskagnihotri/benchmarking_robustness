...
slurm_log_folder_path = "slurm/work_dir_voc"
path_configs_to_train = "./configs_to_train"

folder_entry_list_configs_to_train = os.listdir(path_configs_to_train)

path_erroneous_configs = "./configs_erroneous/verification_voc"
path_verified_configs = "./configs_verified_voc"

slurm_results_path = "slurm/results_voc"
