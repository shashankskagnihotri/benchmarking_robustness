#!/bin/bash
#SBATCH --job-name=submission_atss_swin-b # job name
...
# GPU stats V2
while true; do
  nvidia-smi --query-gpu=utilization.gpu,utilization.memory --format=csv >> ./slurm/train_results/usage_atss_swin-b.log
