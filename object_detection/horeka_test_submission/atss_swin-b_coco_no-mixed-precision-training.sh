#!/bin/bash
#SBATCH --job-name=atss_swin-b_coco_no-mixed-precision-training_no-mixed-precision-training # job name
...
python ./mmdetection/tools/train.py \
    ./horeka_test_submission/atss_swin-b_coco_no-mixed-precision-training.py \
    --work-dir ./slurm/train_work_dir/atss_swin-b_coco_no-mixed-precision-training \
    --resume \
    --auto-scale-lr &
