#!/bin/bash
#SBATCH --job-name=atss_convnext-b_coco_longer-warm-up-smaller-lr # job name
...
python ./mmdetection/tools/train.py \
    ./horeka_test_submission/atss_convnext-b_coco_longer-warm-up-smaller-lr.py \
    --work-dir ./slurm/train_work_dir/atss_convnext-b_coco_longer-warm-up-smaller-lr \
    --resume \
    --auto-scale-lr &
