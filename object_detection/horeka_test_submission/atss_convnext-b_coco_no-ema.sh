#!/bin/bash
#SBATCH --job-name=atss_convnext-b_coco_no-ema # job name
...
python ./mmdetection/tools/train.py \
    ./horeka_test_submission/atss_convnext-b_coco_no-ema.py \
    --work-dir ./slurm/train_work_dir/atss_convnext-b_coco_no-ema \
    --resume \
    --auto-scale-lr &
