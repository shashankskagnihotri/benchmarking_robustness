#!/bin/bash
#SBATCH --job-name=atss_convnext-b_coco_no-autoscale# job name
...
python ./mmdetection/tools/train.py \
    ./horeka_test_submission/atss_convnext-b_coco_no-autoscale.py \
    --work-dir ./slurm/train_work_dir/atss_convnext-b_coco_no-autoscale \
    --resume 
