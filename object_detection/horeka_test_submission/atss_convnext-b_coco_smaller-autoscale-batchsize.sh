#!/bin/bash
#SBATCH --job-name=atss_convnext-b_coco_smaller-autoscale-batchsize # job name
...
python ./mmdetection/tools/train.py \
    ./horeka_test_submission/atss_convnext-b_coco_smaller-autoscale-batchsize.py \
    --work-dir ./slurm/train_work_dir/atss_convnext-b_coco_smaller-autoscale-batchsize \
    --resume \
    --auto-scale-lr &
