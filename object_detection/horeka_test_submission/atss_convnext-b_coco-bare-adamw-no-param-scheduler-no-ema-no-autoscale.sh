#!/bin/bash
#SBATCH --job-name=atss_convnext-b_coco-bare-adamw-no-param-scheduler-no-ema-no-autoscale # job name
...
python ./mmdetection/tools/train.py \
    ./horeka_test_submission/atss_convnext-b_coco-bare-adamw-no-param-scheduler-no-ema-no-autoscale.py \
    --work-dir ./slurm/train_work_dir/atss_convnext-b_coco-bare-adamw-no-param-scheduler-no-ema-no-autoscale \
    --resume \
