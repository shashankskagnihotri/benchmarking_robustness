#!/bin/bash
#SBATCH --job-name=atss_convnext-b_coco-no-mixed-precission-training # job name
...
python ./mmdetection/tools/train.py \
    ./horeka_test_submission/atss_convnext-b_coco-no-mixed-precission-training.py \
    --work-dir ./slurm/train_work_dir/atss_convnext-b_coco-no-mixed-precission-training \
    --resume \
    --auto-scale-lr &
