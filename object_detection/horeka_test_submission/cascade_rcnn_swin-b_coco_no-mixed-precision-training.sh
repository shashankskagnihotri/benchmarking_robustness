#!/bin/bash
#SBATCH --job-name=cascade_rcnn_swin-b_coco_no-mixed-precision-training # job name
...
python ./mmdetection/tools/train.py \
    ./horeka_test_submission/cascade_rcnn_swin-b_coco_no-mixed-precision-training.py \
    --work-dir ./slurm/train_work_dir/cascade_rcnn_swin-b_coco_no-mixed-precision-training \
    --resume \
    --auto-scale-lr &

# GPU stats V2
while true; do
  nvidia-smi --query-gpu=utilization.gpu,utilization.memory --format=csv >> ./slurm/train_results/usage_cascade_rcnn_swin-b.log
