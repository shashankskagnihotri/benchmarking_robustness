...
default_hooks = dict(
    ...
    logger=dict(log_metric_by_epoch=False, type='LoggerHook'),
...
train_cfg = dict(by_epoch=False, max_iters=10000, val_interval=10)
...
work_dir = 'cfg_experiments/work_dir_atss_convnext-b_coco'
