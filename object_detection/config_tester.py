...
slurm_log_folder_path = "./slurm/eval_work_dir"  # ? change to eval for evaluation
slurm_log_folders = os.listdir(slurm_log_folder_path)

slurm_results_path = "slurm/eval_results"  # ? change to eval for evaluation
path_erroneous_configs = "./configs_erroneous_eval"  # ? change to eval for evaluation
                    ...
                    if highest_job_number_for_model in model_logfile:
                        ...
                        if "out" in model_logfile_ending:
                            with open(
                                ...
                                # TODO find out how test output looks like
