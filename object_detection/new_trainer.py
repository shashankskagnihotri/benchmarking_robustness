...
# python -m pudb new_trainer.py configs_erroneous/verification/rtmdet_convnext-b_voc0712.py slurm/work_dir/0_verification_submitit_verifier_trainer_tester/trainer
