...
if __name__ == "__main__":
    args = parse_args()
    trainer(
        config=args.config,  #! "configs_verified/dab_detr_r101_coco.py" #! "configs_erroneous/verification/EfficientDet_swin-b_coco.py" #! configs_verified/EfficientDet_convnext-b_coco.py
