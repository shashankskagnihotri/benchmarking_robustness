...
model = dict(
    ...
    bbox_head=dict(
        ...
        loss_cls=dict(
            loss_weight=1.0, neg_weight=0.75, pos_weight=0.25, type="GaussianFocalLoss"
        ),
        num_classes=20,
        stacked_convs=4,
        strides=[
...
param_scheduler = [
    dict(begin=0, by_epoch=False, end=1333, start_factor=0.00025, type="LinearLR"),
    dict(
        begin=0,
        by_epoch=True,
        end=8,
...
test_evaluator = dict(
    # ann_file="data/VOCdevkit/voc_coco_fmt_annotations/voc07_test.json", # was included
    # backend_args=None, # was included
    # format_only=False, # was included
    metric="mAP",  # was bbox
    type="VOCMetric",  # was CocoMetric
    eval_mode="11points",  # was not included
