...
train_dataset =  get_dataset(args.dataset, args.datapath, split="train", architeture_name="PSMNet")
test_dataset  =  get_dataset(args.dataset, args.datapath, split="test",  architeture_name="PSMNet")
